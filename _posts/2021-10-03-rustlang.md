...
Unlike Python & Go:
   * Rust does not use a garbage collector</strong> because objects in Rust are discarded when the last "owner" goes out of scope.
...
Doug Milford (lambdavalley.com) uses Visual Studio Code (VSCode) IDE on YouTube:
   ...
   * <a target="_blank" href="https://www.youtube.com/watch?v=K-KK_UGuXFI" title="Oct 8, 2019">Rust </a>
   ...
   * <a target="_blank" href="https://www.youtube.com/watch?v=ClPrjjHmo2Y" title="Oct 8, 2019">Rust strings vs slices</a>
   ...
   * <a target="_blank" href="https://www.youtube.com/watch?v=nvur2Ast8hE" title="Nov 17, 2019">Rust Generice</a>
