...
date: "2023-06-14"
file: "tableau"
title: "Data Visualizations using Tableau"
...
* TIBCO Spotfire
* <a target="_blank" href="http://www.qlik.com/us/explore/products/sense">Qlik Sense</a>
* http://www.xdat.org/
...
<a target="_blank" href="https://www.gartner.com/doc/reprints?id=1-254T1IQX&ct=210202/">
<img alt="tableau-gartner-2021-570x592" width="570" height="592" src="https://user-images.githubusercontent.com/300046/159911415-ecc4359b-fee2-468c-bbeb-0f41fa91f119.png"></a>
...
That is why <a target="_blank" href="http://www.tableau.com/learn/whitepapers/forrester-advanced-data-visualization-platforms"> This Forrester report (although rather dated from 2012)</a> has Tableau lagging on the horizontal strategy dimension:
...
to manipulate using the Tableau Public client installed on your laptop.
...
To work through how a homegoods manufacturer can 
...
which is the number of seconds from 1970 (not the number since 1970 as Unix uses).
...
Setup-Tableau-Add-In-7.0.exe. Thus it's only for the Windows edition of Office (not Mac).
...
0. Open a Mac Finder window by holding down the command and pressing Tab until the Finder icon is highlighted.
...
<strong>.txt</strong> files are also considered among "Other files" that Tableau opens.
...
Tableau provides a <a target="_blank" href="http://mkt.tableau.com/files/Desktop-9-CP-Solution-Guide.pdf">Solution Guide</a> which shows constructed viz to answer the certification questions:
...
0. On a Mac, hold down the fn key and click the Data Set link to download the 
...
0. Scroll to see links to the Transcript pdf of the video.
...
0. On a Mac, hold down the fn key and click the _Data Set_ link to download the 
...
So use the link to save the MP4 video file so you can download it for viewing offline.
...
0. [5:01] Drag Dimension Order Date and drop it on the top box. This is equivalent to dropping in the Columns shelf.
...
0. [8:35] Drag Profit to drop on top of Color for a clearer understanding of trends.
0. Click Color Mark.
1. Click Edit Colors.
...
0. Click Marks: Labels and choose Show mark labels (so text appears).
...
Product Manager Neelesh Kamkolkar (@Neelesh Kamkol) has videos and blogs:
   ...
   * <a target="_blank" href="https://www.tableau.com/about/blog/2015/4/introducing-tabjolt-point-and-run-load-testing-solution-tableau-server-38604">
...
($250 to answer 16 questions over two hours).
...
provides an introduction to use Excel and SQL and Tableau
...
The Tableau Foundation provided software to track individuals in a "command center" used to
<a target="_blank" href="https://app.getpocket.com/read/2518879365">
eliminate veteran homelessness</a>.
