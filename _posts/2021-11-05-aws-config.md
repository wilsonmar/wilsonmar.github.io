...
excerpt: "Dynamically audit AWS resource configurations under organization units using OPA Rego, Lambda alerts using SNS through EventBridge, then automatically remediate (via SSM)"
...
"AWS Control Tower" is a part of AWS Organizations managed by corporate-level Global Administrators. 
Those administrators use the AWS Control Tower's <strong>centralized dashboard</strong> to view AWS Config rule compliance status across Organization Units used to manage AWS accounts.

<a target="_blank" href="https://www.youtube.com/watch?v=3-aaw-B1j8Y">VIDEO:
AWS Control Tower Overview and Landing Zone Hands-On</a>
...
PROTIP: The more <a target="_blank" href="https://wilsonmar.github.io/well-architected-cloud/">aspects of Well-Architected cloud usage</a> covered to benefit, the more likely people will buy into the work here.
   ...
   * <a target="_blank" href="https://docs.aws.amazon.com/config/latest/developerguide/WhatIsConfig.html">AWS Config Developer Guide: What is AWS Config?</a><br />
   <br /><br />
...
AWS Config with RDK (Rule Development Kit)</a> within AWS Organizations Control Tower.
