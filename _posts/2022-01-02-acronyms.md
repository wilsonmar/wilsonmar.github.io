...
excerpt: "Because it's often difficult to know where an acronym is from, here are all 900+ in one page: IT, Security, Networking, <a target="_blank" href="https://docs.aws.amazon.com/whitepapers/latest/cicd_for_5g_networks_on_aws/acronyms.html">AWS</a>, Azure, GCP, Finance, Marketing, Business, OMG!"
...
*	S3	=	Simple Storage Service	(AWS file service)			
