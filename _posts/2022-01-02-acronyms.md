...
date: "2023-08-14"
file: "acronyms"
title: "900+ Acronyms (and contractions)"
...
*	OIDC	=	OpenID Connect	(open authentication protocol that profiles and extends OAuth 2.0 to add an identity layer. OIDC allows clients to confirm an end user‚ identity using authentication by an authorization server.)			
...
*	PPG	=	Point-to-Point Tunneling Protocol				
...
* PV	=	ParaVirtual (type of Linux AMI boot loader)
...
*	SARIF	=	Static Analysis Results Interchange Format  (standard for sharing static vulnerability analysis results)
...
*	SQS	=	Simple Queue Service	(AWS hosted queues)			
