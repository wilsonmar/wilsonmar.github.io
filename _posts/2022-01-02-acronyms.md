...
date: "2023-09-20"
file: "acronyms"
title: "Acronyms (and contractions)"
excerpt: "Because it's often difficult to know where an acronym is from, here are all 900+ in one page: Quantum IT, Security, Networking, Amazon, Azure, GCP, Finance, Marketing, Business, OMG!"
...
*	DEK	=	Data Encryption Key	(secret generated from Customer Managed keys to protect data stored in SQL databases)
...
*	HTAP	=	Hybrid Transaction and Analytics Processing (Microsoft workload)
...
*	MDM	=	Master Data Management (a single source of truth for critical corporate data)
...
*	MTBF	=	Mean Time Between Failuress
...
*	PQC	=	Post-Quantum Cryptography (Quantum IT)
...
* RAG = Retrieval Augmented Generation (Amazon AI using Aurora PostgreSQL pgvector extension to add proprietary knowledge to foundation models without retraining)
...
*	RDD	=	Resilient Distributed Dataset (legacy Apache Spark)
...
*	SKSKSKSK	=	(expressing excitement)
