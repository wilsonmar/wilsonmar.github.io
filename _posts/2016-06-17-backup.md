...
What are needed are not just backups, but <strong>Snapshots</strong> which add to backup data <strong>versioning and other metadata</strong>, usually taken more frequently than once a day.
