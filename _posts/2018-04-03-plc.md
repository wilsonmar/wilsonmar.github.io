...
layout: post
date: "2025-07-17"
lastchange: "v010 + certs study :2018-04-03-plc.md"
...
Alphabetical Index: <a href="#Actuators">Actuators</a>, <a href="#DNP3">DNP3</a>, <a href="#ERP">ERP</a>, <a href="#Install">Install</a>, <a href="#ISA95">ISA95</a>, <a href="#Launch">Launch</a>, <a href="#LIM">LIM</a>, <a href="#MakerEdition">Maker Edition</a>, <a href="#MES">MES</a>, <a href="#Modules">modules</a>, <a href="#MQTT">MQTT</a>, <a href="#MRP">MRP</a>, <a href="#OEE">OEE</a>, <a href="#OPC-UA">OPC</a>, <a href="#Perspective">Perspective</a>, <a href="#PLCs">PLCs</a>, <a href="#Releases">Releases</a>, <a href="#SCADA">SCADA</a>, <a href="#Sensors">Sensors</a>, <a href="#SFC">SFC</a>, <a href="#Tags">Tags</a>

<a name="ISA95"></a>

The <a target="_blank" href="https://7451111251303.gumroad.com/l/pussom">hierarchy diagram below</a> is adapted from the <a target="_blank" href="https://www.hivemq.com/resources/smart-manufacturing-using-isa95-mqtt-sparkplug-and-uns/">ISA95</a> (International Society of Automation) model data objects pushed to an enterprise Unified Namespace. <a target="_blank" href="https://www.wikiwand.com/en/articles/ANSI/ISA-95">ANSI-ISA95</a> is a large specification with many parts developed over many years.
...
<a name="PLCs"></a>
<a name="SCADA"></a>
Industrial companies manage:
* <strong>PLCs</strong> (Programmable Logic Controllers) that <strong>automate</strong> remote operation of equipment. Communication of inputs and outputs to and from each PLC is supervised by a
* <strong>SCADA</strong> (Supervisory Control and Data Acquisition) system.
...
* <strong>MES</strong> (Manufacturing Execution System) to make more efficient use of limited capacity by reducing bottlenecks - by calculating alternative routings in production.
...
The <a target="_blank" href="https://www.youtube.com/watch?v=IAhxYsMi4e8">Purdue "Automation Pyramid"</a> provides a way to organize the vocabulary of modules systems:<br />
<a target="_blank" href="https://inductiveautomation.com/resources/article/the-purdue-model-and-ignition"><img src="https://res.cloudinary.com/dcajqrroq/image/upload/v1752804269/plc-purdue-model-1999x1829_wkjci7.png" /></a>

People at the Enterprise level manage the "Cloud Edition Gateway", cloud injectors, SAP ERP, and systems for:
* Workforce Management
* Order Management
* Inventory Management
* Proxy and Firewall to separate networks
...
People at the Operations level manage the "Central Ignition Gateway", admin. clients, and systems for:
* MES (Manufacturing Execution System)
* Scheduling
* <a name="OEE"></a><a target="_blank" href="https://bomonike.github.io/oee">OEE (Overall Equipment Effectiveness)</a>
* Quality Management

People doing Supervisory Control manage the "Local Ignition Server", local clients, and site <a href="#EdgeServers">Edge IIoT servers</a> managed using <a href="#EdgePanel">Edge Panel UI</a>:

People doing Process Control manage the physical <a target="_blank" href="https://www.youtube.com/watch?v=QC3Bd2ynC7c">VIDEO</a>:
* PLCs are programmed with code and
* RTUs (Remote Terminal Units) which have a web interface to lots of inputs, outputs, intelligence".

People working on "Physical Processses" manage Sensors and Actuators (that take action).
...
InductiveAutomation provides a "Touch Panel" (Edge Panel) that communicates with PLCs in their manufacturer's native protocol to access a 1-week data buffer.
