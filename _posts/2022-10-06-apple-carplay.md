...
CarPlay works with every iPhone released since the launch of the iPhone 5 back in late 2012,
but CarPlay does not work with iPads or iPods.
...
https://www.apple.com/ios/feature-availability/#applecarplay-applecarplay
Features
...
1. Hold down the voice-command button on your steering wheel while you say your request for <a target="_blank" href="https://support.apple.com/siri">Siri</a> to process voice commands.
    Make sure your vehicle is in wireless or Bluetooth pairing mode.

1. On your iPhone, go to Settings  > General > CarPlay > "Allow CarPlay while locked".

   Available Cars. Choose your vehicle.

1. Since Siri is an internet-connected tool, it relies on an <strong>active cell phone data connection</strong>. So there will be a few seconds of lag between your utterance and what to want to happen.

   At time of writing, Siri can change the volume.
   
   But Siri can't raise the car's temperature or activate cruise control. 

1. Install listening apps: Apple Podcasts, Audiobooks, Amazon Music, Audible, Downcast, Pandora, Spotify, iHeartRadio, AudioBooks.com, CBS Radio, NPR One, Overcast, YouTube Music, SiriusXM Radio, VOX, LiveXLive, Line, Tidal

1. Beginning with select 2021 car models, you can unlock and start your car with iPhone. Sharing keys with friends or family is easy too. Car keys will even work for up to five hours after your iPhone battery runs out.

### CarPlay Updates

https://www.youtube.com/watch?v=ptgKnZJnaRc
...
rumors indicate that Apple wants to design a car with no steering wheel and no pedals. 
