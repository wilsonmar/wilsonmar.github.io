...
PROTIP: Although each cloud vendor has services that also does what Splunk does, many choose Splunk to avoid cloud vendor lock-in while going multi-cloud.
