...
tags: [API, devops, databases]
image:
  feature: https://res.cloudinary.com/dcajqrroq/image/upload/v1690112503/splunk-hero-1900x500_ekgw1u.png
  credit: Wilson Mar
  creditlink: 
comments: true
---
...
On <a target="_blank" href="https://techcrunch.com/2023/09/21/cisco-to-acquire-splunk-in-28b-mega-deal/">Sep 21, 2023</a>, Cisco announced it will acquire Splunk for $28 billion in cash and stock. The deal is expected to close in the second half of 2024.

   * 75% of Splunk employees would recommend to a friend, according to <a target="_blank" href="https://www.glassdoor.com/Reviews/Splunk-Reviews-E117313.htm">surveys by Glassdoor</a>, versus<br /><a target="_blank" href="https://www.glassdoor.com/Reviews/Cisco-Systems-Reviews-E1425.htm">89% of Cisco employees</a> (which is among the top 5% of all US companies). So that's positive news for employees.
...
Splunk, Inc. is headquartered at <a target="_blank" href="https://goo.gl/maps/2vW5TfHr2xZU1hu49">270 Brannan St</a>, San Francisco, California 94107. +1 415.848-8400.
...
<a target="_blank" href="https://res.cloudinary.com/dcajqrroq/image/upload/v1690475698/splunk-platform-1190x555_m5zpkc.png"><img alt="splunk-platform-1190x555.pn" src="https://res.cloudinary.com/dcajqrroq/image/upload/v1690475698/splunk-platform-1190x555_m5zpkc.png"></a>
...
"Splunk can be used for ALL your data needs." 
It is a data platform. It is a data lake. It is a data warehouse. It is a data lakehouse. ;)
...
* <a href="#Central">SOC Automation & Orchestration</a>
* <a href="#Automation">Advanced threat detection</a>
* <a href="#Hierarchy">Application modernization</a>
* <a href="#Analytics">Extend visibility to the cloud</a> (modernization)
* <a href="#Scale">Incident Investigation & Forensics</a>
* <a href="#Time">Isolate Cloud Native Problems</a>
<br /><br />

The <a target="_blank" href="https://www.splunk.com/en_us/solutions.html">full list</a> also has:
...
<a href="#SOAR">Security, Orchestration, Automation and Response (SOAR)</a> - see below.
...
<a target="_blank" href="https://d3fend.mitre.org/">d3fend.mitre.org</a>
(MITRE D3FEND) is the response to MITRE ATT&CK.
detonate files, quarantine hosts, disable users, revoke tokens.
-- Peter Kaloroumakis, D3FEND Lead.
Techniques to Playbooks (step-by-step)
Splunk Enrichment Response Packs of an Analytics Story for Response.
...
SOAR playbooks enable swifter responses to triggers, thus reducing incident response time.
...
<a target="_blank" href="https://www.splunk.com/en_us/training/certification-track/splunk-es-certified-admin.html">Splunk Enterprise Security Certified Admin</a> is among the most expensive of all certifications: $4,625.
...
If there is an existing bucket defined for a time span that include the time of the data,<br />
...
<tt>maxHotBuckets = 3</tt> is the default, for 2 normal buckets are open at a time, plus
a final bucket slot reserved for quarantined data.

QUESTION: Quarantined  data?

Larger number of buckets for a high volume index or if there are regular delays in event delivery.
The more hot buckets Splunk has open, the greater the time range to cover for events.
...
<tt>maxHotSpanSecs = 777600</tt> default for 90 days.
3 maxHotBuckets would yield 240 days.
Change if there are regularly larger than expected timespans.
This can be overruled by Splunk.

<tt>minHotIdleSecsBeforeForceRoll = auto</tt> for Splunk to autotune (starting at 600 secs).
...
But if an event does not fit into an existing hot bucket,
if there is at least one bucket idle long enough to be allowed to <strong>roll</strong>,
Splunk closes the hot bucket with the longest idle time before creating a new hot bucket.
...
Using Splunk and JA3/s hashes to detect malicious
activity on critical servers

https://learning.oreilly.com/library/view/sams-teach-yourself/9780135182925/
SQL in 10 Minutes, 5th Edition, 2019, by Ben Forta: 

https://learning.oreilly.com/library/view/unix-and-linux/9780134278308/
Unix and Linux System Administration Handbook, 5th Edition, by Evi Nemeth et al
