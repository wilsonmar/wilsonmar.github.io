...
1. Log into <a target="_blank" href="https://portal.azure.com/#allservices">https://portal.azure.com/#allservices</a>, the Azure Portal and select "Internet of Things" on the left menu for a menu of services:
   ...
   <img width="1092" alt="azure-iot-services-2184x1122.png" src="https://user-images.githubusercontent.com/300046/71761044-96928680-2e83-11ea-9a97-629f84e54f68.png">

   The interaction among Azure IoT services are diagrammed below.
...
1. The most in-depth instructions for builders are at:
   ...
   PROTIP: You don't need to visit <a target="_blank" href="https://iotschool.microsoft.com/en-us/home">https://iotschool.microsoft.com/en-us/home</a>, the Azure "IoT School", which contains links to two learning paths:
...
0. Triple-click on the command below and command+C to copy it to your Clipboard, then in a macOS Terminal or Windows Git Bash window, press command+V to paste and run the installer.
   ...
   PROTIP: The script was written based on my tutorial on Bash scripts.
