...
1. For starters, visit Microsoft's marketing page for its various IoT offerings:
   ...
   <a target="_blank" href="https://azure.microsoft.com/en-us/overview/iot/">azure.microsoft.com/en-us/overview/iot</a> 

   In that page links to reports from analysts such as <a target="_blank" href="https://cloudblogs.microsoft.com/industry-blog/manufacturing/2019/07/10/idc-marketscape-microsoft-a-leader-in-iiot-platforms-for-manufacturing-and-energy/">"DC MarketScape: Microsoft a leader in IIoT platforms for manufacturing and energy", which presents this diagram showing Microsoft dominating in Manufacturing and Energy:
...
1. If you're a builder focused on technolgies, the most in-depth instructions are at:
...
see<br /><a target="_blank" href="https://iotschool.microsoft.com/en-us/home">https://iotschool.microsoft.com/en-us/home</a>, the Azure "IoT School". Near the bottom are links to two learning paths:
   ...
   * <a target="_blank" href="https://iotschool.microsoft.com/en-us/iot/learning-paths/2xRPONGJ9Gkae4o8MgySKm">Digital transformation with Azure IoT</a>
   ...
   BLAH: I was confused by the sequence of the modules there, which when clicked, send you to GitHub repositories for the actual presentation: <a target="_blank" href="https://github.com/Azure-Samples/azureiotlabs">https://github.com/Azure-Samples/azureiotlabs</a>, which is organized around this diagram:
   

## IoT Workflow diagram

<img src="https://github.com/Azure-Samples/azureiotlabs/raw/master/images/Lab.png">
...
First achievements are:

But before you do that, manually do the following:
...
1. Log into <a target="_blank" href="https://portal.azure.com/#allservices">https://portal.azure.com/#allservices</a>, the Azure Portal.
...
1. Select <strong>Azure IoT Hub</strong> a Resource Group for your local region.
   ...
   Pick "Internet of Things" from among the Azure Marketplace. Pick the "IoT Hub" on the "S1 - Standard" tier.
...
0. Visit the "Azure IoT Developer Center" at<br /><a target="_blank" href="http://azure.com/iotdev">
   http://azure.com/iotdev</a>, which redirects to
