...
1. Log into <a target="_blank" href="https://portal.azure.com/#allservices">https://portal.azure.com/#allservices</a>, the Azure Portal and select "Internet of Things" on the left menu for a menu of services:
   ...
   Nowadays, many begin by buying the <a href="#MXChip">"MXChip"</a> hardware depicted on the left side of the diagram.
   ...
   The MXChip is an Arduino board with several sensors added to detect humidity, barometric pressure, magnetism (magnetometer).
...
This tutorial provides in one command what other tutorials assume are manually typed:
