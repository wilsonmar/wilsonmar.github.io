...
<a target="_blank" href="https://user-images.githubusercontent.com/300046/58937069-9c2dbf80-872e-11e9-9b9d-2680489b8c4b.jpg"><img width="1024" alt="ansible-flow-v02-1024x580-49160" src="https://user-images.githubusercontent.com/300046/58937069-9c2dbf80-872e-11e9-9b9d-2680489b8c4b.jpg"></a>
...
"ansible" is one of the 9 command-line executables installed by <strong>Python</strong> when the <strong>Ansible (Core) Control Server</strong> is installed.
The word "Core" is there because it is a dependency of the <strong>Ansible Tower</strong> product which provides an API and GUI front-end to the open-source Control Server, which provides only a <strong>command line interface</strong>.
...
Files in the Galaxy are versioned in  a <strong>GitHub repository</strong> files can also be pulled by a <strong>Git</strong> program, which can pull other files such as the <strong>inventory</strong> of host nodes to be populated.

When the ansible program is run, to delegates work to <a href="#Modules">Modules</a>. Additional modules can be defined, 
...
### Roles, Playbook, Taks, Plays

Each role is a (subroutines) which make code in <strong>playbooks</strong> reusable by putting the functionality into generalized "libraries" that can be then used in any playbook as needed.
