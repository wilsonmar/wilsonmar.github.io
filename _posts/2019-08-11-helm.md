...
Thus, Helm competes with docker-compose. A Helm Chart groups multiple <a target="_blank" href="https://yaml.org/spec/">yaml format</a> (Kubernetes objects) into one unit. In yaml files, indents use two spaces (and never tabs).
