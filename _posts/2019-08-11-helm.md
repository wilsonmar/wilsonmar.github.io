...
A Chart groups multiple <a target="_blank" href="https://yaml.org/spec/">yaml format</a> (Kubernetes objects) into one unit. In yaml files, indents use two spaces (and never tabs).
...
3. Visit <a target="_blank" href="https://github.com/helm/helm">https://github.com/helm/helm</a> where Helm is open-sourced.

4. Visit <a target="_blank" href="https://helm.sh/docs/">https://helm.sh/docs</a>
...
<a target="_blank" href=https://user-images.githubusercontent.com/300046/74785670-d1584e80-5278-11ea-9eb5-722c0fc4fa10.jpg">
<img alt="helm-ibm-1151x649.jpg" width="1151" src="https://user-images.githubusercontent.com/300046/74785670-d1584e80-5278-11ea-9eb5-722c0fc4fa10.jpg"></a>
...
Helm stores its configuration files in XDG directories created the first time helm is run.
...
└── values.yaml
   ...
   Its <tt>chart folder</tt> can contain "dependencies" of other charts with its own set of yaml files.
...
2. To see logos among publicly available charts, view <a target="_blank" href="https://hub.helm.sh/">https://hub.helm.sh</a>, search for "stable" Charts:
