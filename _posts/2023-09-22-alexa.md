...
## Developer Buzzwords
    ...
    The pre-built or custom <strong>interaction model</strong> consists of the words and phrases people use to communicate with your skill. 
...
1.  Click the Create Skill button.
    ...
    ### Tutorials on building Alexa Skill

    * <a target="_blank" href="https://www.youtube.com/watch?v=RzS69XCe9cw">Build Statue of Unity Facts skill</a> from Rahul Patel. It's based on the Hello World template.
