...
Some people are concerned about Alexa devices listening to conversations and sending them to Amazon for analysis.
...
## Alexa works with your mobile app

1.  On your iPhone App Store or Android, install app "Amazon Alexa" under "Lifestyle" from "AMZN Mobile LLC" (Amazon).
1.  Open the app.
