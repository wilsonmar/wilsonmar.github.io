...
Select Device Settings. Select your device. Select Communications. Select Drop In. Select On. Select Household Only. Select Save.
...
1.  <a target="_blank" href="https://www.youtube.com/watch?v=NHswkfcpz_M&t=4m9s">VIDEO</a>: Turn off "Drop In". Repeat for each device.
...
1.  PROTIP: Say a prompt using <strong>built-in skills</strong>, such as:
    ...
    * NPR (for National Public Radio news)
    ...
    * Flash briefing
    * Ted Talks
    * Associated News, Bravo, CBS, CNET, CNN, Daily Tech, Engadget, ESPN, Fox, NBC, 
    * Pandora, Spotify, TuneIn, Food Network, iHeartRadio, SiriusXM, 
    <br /><br />
...
1.  The Alexa-enabled device sends a request to the Alexa service. Alexa determines what the user wants or intends to do. Then the service checks to see if the skill can handle that task. If so, it sends the request to the skill's hosting service. The hosting service executes the skill code and returns a response, including text for Alexa to speak. If the device has a screen, the response also has a visual component, such as an image, video, animation, or on-screen text.
    ...
    * Ask Sleep Sounds to play Thunderstorms / Rain Sounds / Ocean Sounds / Babbling Brook / Fireplace Sounds / White Noise / City Sounds / Rainforest Sounds / Crickets / Fan Sounds / Cat Purring / Airplane Sounds / Train Sounds / Vacuum Sounds / Pink Noise / Brown Noise / Windy Leaves / Dripping Water / Frogs / Birds / Clock / Tibetan Bowl / Wind Chimes / Cat Meowing / Whale Sounds / Heartbeat / Crowd Sounds / Clock Ticking / Washing Machine / Dishwasher / Clothes Dryer / Car Ride / Car Engine / Shower / City Rain / Rain on a Tent / Rain on a Tin Roof / Rain on a Window / Rain on a Car Roof / Rain on a Metal Roof / Rain on a Wood Roof / Rain on a Fiberglass Roof / Rain on a Canvas Roof
    ...
    You can access information associated with lists you've setup in your Amazon account:

    * Add milk to my <strong>Grocery List</strong>
    * Alexa - add call steve to my <strong>ToDo list</strong>
    <br /><br />

    * Tell SMS with Pamela to text Jim "Vamanos".
    <br /><br />
    ...
    * "Alexa, ask Premium Trivia for a sports question."
    ...
    Say “Alexa, call for help” for hands-free 24/7 Urgent Response, Smart Alerts, and Emergency Contacts to help keep everyone you care about safe while at home or away.
...
1.  REMEMBER: Skills that have several steps you need to repeat the skill name with every utterance. This will be fixed soon by Amazon I hope.

    1. Alexa - Ask All Recipes, what can I make with Chicken & ketchup? 
...
When AI is enabled, Alexa users can program complex <strong>Routines</strong> (a series of actions) such as: “Alexa, every weeknight at 9 p.m., make an announcement that it’s bed time for the kids, dim the lights upstairs, turn on the porch light, and switch on the fan in the bedroom."

<a target="_blank" href="https://www.youtube.com/watch?v=kVYfiB5FlWs">VIDEO: LLM and Generative AI tools for Alexa developers</a> 

    * character.ai remembers conversations and adapt to the user's personality.
...
<a target="_blank" href="https://www.youtube.com/watch?v=RzS69XCe9cw">Build Statue of Unity Facts skill</a> based on the Hello World template.
