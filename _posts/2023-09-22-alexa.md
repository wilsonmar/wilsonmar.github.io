...
layout: post
date: "2025-10-01"
lastchange: "25-10-01 v009 + x10 :2023-09-22-alexa.md"
url: https://wilsonmar.github.io/alexa
file: "alexa"
title: "Alexa (from Amazon)"
excerpt: "Here are my notes on creating Alexa audio voice skills programs, now with more AI than ever!"
tags: [AI,AWS,IoT]
image:
...
Amazon has put Alexa Natural Language Processing (NLP) smarts available in several types of devices:
   ...
   * <a target="_blank" href="https://www.amazon.com/dp/B09SVFP7YC/">Amazon's Echo Frames sunglasses $135 3rd gen</a> (requires <a target="_blank" href="https://www.amazon.com/dp/B0DCCNHWV5">Alexa+ subscription included with Prime</a>)
...
<a target="_blank" href="https://www.homecontrols.com/Manufacturers/x10">X10</a> is a protocol for communication over electrical wires. It was created before Alexa so  are not natively compatible with Alexa to enable voice control of X10 switches via Alexa.

To make Alexa recognize and control X10 switches requires a bridge system that translates Alexa and the X10 protocol:  Mochad, and TRIGGERcmd.

* https://github.com/armzilla/amazon-echo-ha-bridge (Java 1.8 app) emulates the Phillips Hue API for use by other home automation gateways.
* <a target="_blank" href="https://github.com/bwssystems/ha-bridge">HA-Bridge</a> 
* <a target="_blank" href="https://www.youtube.com/watch?v=Kj5SxV2616U">VIDEO</a>: X10 Commander controls X10 devices from their "X10 Commander" app (from Melloware).

https://www.youtube.com/watch?v=WNyph5QG8zI
...
PROTIP: Instead of the Alexa-branded Smart Home devices from Amazon, I recommend 3rd-parties who created devices that work with both Alexa and Google Home:
   ...
   * CAUTION: Use of the 3rd-party app needs to be installed to work with Smart light switches from <a target="_blank" href="https://www.amazon.com/Tapo-Compatible-Certified-S500-4-Pack/dp/B0DHYLF7PQ/">TP-Link Tapo</a>, 
   * Some switches require a <strong>neutral wire</strong> installed. Leviton's Decora Smart <a target="_blank" href="https://www.amazon.com/Leviton-No-Neutral-Assistant-Wire-Free-DN15S-1RW/dp/B0C9S6NQHS/">$40 No-Neutral dimmers (DN6HD)</a> <a target="_blank" href="https://www.amazon.com/Leviton-No-Neutral-Assistant-Wire-Free-MLWSB-1RW/dp/B0CB22CTTV/">$39 MLWSB Wi-Fi Bridge</a> is needed to work with their "My Leviton" app 
   * The large switches would not fit inside standard electrical boxes. 
   <br /><br />
