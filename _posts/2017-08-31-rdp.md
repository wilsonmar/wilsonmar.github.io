...
0. Click "Download".
0. Select "Save" folder to receive file<br />
...
0. In Finder, navigate to Downloads folder to double-click on that zip file to unzip it.
0. Scroll to "Microsoft Remote Desktop Beta".
0. If you're the suspicious type, run md5 on the file to see if the hash created matches the one on the website.

0. Double-click on the unzipped file to invoke it.
