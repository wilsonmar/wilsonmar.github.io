...
excerpt: "Prove that tools emulating users (Playwright, JMeter, Selenium, etc.) can recognize the gamut of controls on a challenging web app."
...
Ruby code to create "the-internet" was at account saucelabs but forked to:
...
24. <a target="_blank" href="https://the-internet.herokuapp.com/horizontal_slider"><img width="21" src="https://user-images.githubusercontent.com/300046/60136601-daccfd80-9761-11e9-8641-3bd7489f0afd.png"></a> <a target="_blank" href="https://github.com/wilsonmar/jmeter-scripts/tree/main/the-internet/"><img width="21" alt="jmeter" src="https://user-images.githubusercontent.com/300046/124912784-965cd500-dfab-11eb-9dd1-d23966aeed48.png"></a><a target="_blank" href="https://raw.githubusercontent.com/flood-io/element/master/examples/internet-herokuapp/24-Horizontal_Slider.ts"><img width="21" alt="flood.io Element script" alt="flood.io Element script" src="https://playwright.dev/img/playwright-logo.svg"></a> Horizontal Slider
25. <a target="_blank" href="https://the-internet.herokuapp.com/hovers"><img width="21" src="https://user-images.githubusercontent.com/300046/60136601-daccfd80-9761-11e9-8641-3bd7489f0afd.png"></a> <a target="_blank" href="https://github.com/wilsonmar/jmeter-scripts/tree/main/the-internet/"><img width="21" alt="jmeter" src="https://user-images.githubusercontent.com/300046/124912784-965cd500-dfab-11eb-9dd1-d23966aeed48.png"></a><a target="_blank" href="https://raw.githubusercontent.com/flood-io/element/master/examples/internet-herokuapp/25-Hovers.ts"><img width="21" alt="flood.io Element script" alt="flood.io Element script" src="https://playwright.dev/img/playwright-logo.svg"></a> Hovers
...
### Emulate using PlayWright

We use the <strong>PlayWright?</strong> service in the cloud (or on-premises) to emulate those many users by running automation scripts pulled from a <a href="#ScriptsInGitHub">GitHub repository</a>.

PlayWright scripts are a new innovation because it emulates <a href="#ManualActions">manual actions</a> within each user's browser.
...
While learning on a local machine such as a Mac, Linux laptop, or Windows PC:
   ...
   2. The setup.sh CLI shell script is installed to run scripts to emulate a <strong>single user</strong>'s manual actions on a Google's Chrome browser.
