...
1.  PROTIP: For those using RBAC, select a pre-defined user group rather than creating a new one.
...
Architecture diagram
Let’s create a user group on IAM and attach the pre-created policy to it:
