...
1. Search for IAM (or pull down a browser bookmark)
   ...
   <a target="_blank" href="https://aws.amazon.com/blogs/security/techniques-for-writing-least-privilege-iam-policies/">PROTIP</a>: Design the permissions you need for each service before coming here. For example: Lambda, S3, DynamoDB). This is so you're not giving out "FullAccess" but use a more granular least privilege approach.
...
1. Click "JSON" tab. Notice:
   
   * Each statement has a "Sid" label.
