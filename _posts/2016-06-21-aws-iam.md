...
1. PROTIP: Look at the "Character count" at the lower-left corner.
   ...
   REMEMBER: Each JSON document has a limit of <strong>6,144</strong> bytes.

1. Tags are not required by AWS, but likely are when Terraform Enterprise Sentinel policies are used.
