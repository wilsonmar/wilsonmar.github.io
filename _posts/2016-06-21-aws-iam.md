...
Here is a step-by-step tutorial to use the AWS Management Console GUI to create a group policy for Lambda, S3 Bucket, DynamoDB. Then attach users to the group.
   ...
   1. <a href="#AttachUsers">Attach Users to Group</a>
   <br /><br />
...
1. Search for IAM (or pull down a browser bookmark)
   ...
   PROTIP: Design the permissions you need for each service before coming here. For example: Lambda, S3, DynamoDB). This is so you're not giving out "FullAccess" but use a more granular least privilege approach.
