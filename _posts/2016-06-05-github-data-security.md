...
3. <a href="#Forgot">You may forget to add .gitignore or remove local secrets</a>
4. <a href="#SecretsRemain">Secrets remain in prior commit history</a>
...
3. <a href="#UseVariables">Refer to secrets as environment variables in your code</a>
4. <a href="#RemoveHistory">Remove secrets in prior commit history on GitHub</a>
...
8. <a href="#SSH_certs">Rotate SSH keys automatically daily as certificates generated by a client referencing a CA</a>
<br /><br />
