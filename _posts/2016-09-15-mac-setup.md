...
To take with a new laptop:
   ...
   4. <a href="#DownloadScript">Follow steps to copy commands for pasting on your Terminal:

      <a target="_blank" href="https://github.com/wilsonmar/mac-setup/"><u>github.com/wilsonmar/mac-setup</u></a>

   5. <a href="#Customize">Customize dotfiles and mac-setup.sh to your liking</a>.

   6. <a href="#Automate">Copy and paste to run automation for <strong>mac-setup</strong> and configure</a>

   7. <a href="#ChromeBrowserSetup">Open Google Chrome browser and configure Profiles</a>
   <br /><br />

   8. <a href="#AppleApps">Open <strong>App Store</strong> app to manually install apps managed by Apple</a>

<hr />

<a name="DownloadScript"></a>

## Copy and paste command in Terminal to download the mac-setup script

1. Open Safari (the Mac's built-in internet browser) to review the script code at:
...
1. If you want to run the script as-is, use your mouse to triple-click the command below to highlight it, then press command+C to copy it to your Clipboard:
   ...
   You and your team may want a different set of utilities and apps to install.
