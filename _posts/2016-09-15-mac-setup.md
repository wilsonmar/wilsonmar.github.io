...
<a name="GUIManualConfig"></a>

## GUI Manual config

Manual steps to take with a new laptop:

   1. Obtain a macOS laptop from Apple. Unbox it. Order <a target="_blank" href="https://wilsonmar.github.io/apple-macbook-hardware/">Apple hardware accessories</a>. Arrange it all on your desk for convenient access.
   ...
   4. <a href="#DownloadScript">Copy and paste command in Terminal to download the <strong>mac-setup</strong> script</a>
   
   5. <a href="#Customize">Customize the mac-setup specifications to your liking</a>.
