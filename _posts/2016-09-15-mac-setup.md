...
<a target="_blank" href="https://www.youtube.com/watch?v=JrCMCdvoMAw">VIDEO</a>: <a target="_blank" href="https://www.chezmoi.io/comparison-table/">comparison of Dotfiles managers at https://www.chezmoi.io</a> by Tom Payne, identifies Go-based <tt>brew install chezmoi</tt> as the only one with Password manager integration!
