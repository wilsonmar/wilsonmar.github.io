...
file: "mac-setup"
title: "Mac setup"
excerpt: "Quickly build and update your macOS laptop with the most useful software for developers -- no more dreading losing your laptop, using my shell script."
...
1. Hold down the <strong>Command</strong> key and press <strong>spacebar</strong> to pop up the Spotlight Search form.
1. Type on top of "Spotlight Search" enough of <strong>Terminal</strong> for that to appear in the drop-down.
...
1. Type <tt>pwd</tt> to see the current folder you are in. The path shown is also stored in a variable named <tt>$HOME</tt>.
1. Type <tt>ls -al</tt> to see the files in the current folder. The <tt>-al</tt> parameters are passed to the <tt>ls</tt> command to show all files in a list.
...
1.  Configure what you want installed.
 
    * Edit <a target="_blank" href="https://wilsonmar.github.io/browsers">browser add-ons</a>
    <br /><br />
...
<a href="#BasicUtils">15. Install basic utilities (git, jq, yq, tree, etc.) used by many

   yq takes a YAML file as input and can: https://learnk8s.io/templating-yaml-with-code
...
Switch to use an internet browser to see my list of programs for macOS at
...
<a target="_blank" href="https://www.youtube.com/watch?v=JrCMCdvoMAw">VIDEO</a>: <a target="_blank" href="https://www.chezmoi.io/comparison-table/">comparison of Dotfiles managers at https://www.chezmoi.io</a> by Tom Payne, identifies Go-based MIT-licensed <tt>brew install chezmoi</tt> as the only one with Password manager integration!
