...
Manual steps to take with a new laptop:
   ...
   1. Connect a USB backup drive and open <strong>Time Machine</strong>
   1. Open <strong>App Store</strong> app to install apps managed by Apple
   1. Obtain automation for <strong>mac-setup</strong> and configure
   1. Open Terminal app and copy Command-line profile and apps
...
## Obtain automation for mac-setup and configure
