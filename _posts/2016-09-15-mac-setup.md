...
Manual steps to take with a new laptop:
   ...
   1. <a href="#TimeMachine">Connect a USB backup drive and open <strong>Time Machine</strong> to save a baseline before making changes.</a>
   1. <a href="#AppleApps">Open <strong>App Store</strong> app to manually install apps managed by Apple</a>
   1. <a href="#Automate">Copy and paste to run automation for <strong>mac-setup</strong> and configure</a>
   1. <a href="#ChromeBrowserSetup">Open Google Chrome browser and configure Profiles</a>
   <br /><br />
...
## Save baseline to Time Machine

"Time Machine" is installed by default on all Apple macOS machines.

Time Machine stores complete backups to the hard drives on the laptop.

Time Machine can also save backups in an external USB drive such that a new laptop can be made to contain all files in the backup.
...
## Copy and paste to run automation for mac-setup and configure

1. Copy the command below, 

1. Open a Terminal

1. Paste the command which downloads the <strong>mac-setup</strong> repository from GitHub and invoke it. 
