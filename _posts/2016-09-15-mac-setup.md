...
6. <a href="#DownloadScript">Follow steps to copy commands for pasting on your Terminal:

      <a target="_blank" href="https://github.com/wilsonmar/mac-setup/"><u>github.com/wilsonmar/mac-setup</u></a>

7. If you want to run the script as-is, use your mouse to triple-click the command below to highlight it, then press command+C to copy it to your Clipboard:
...
8. Press command+V to paste the command from your Clipboard. It starts running.
...
9. Alternately, edit the configuration file and run Ansible.
