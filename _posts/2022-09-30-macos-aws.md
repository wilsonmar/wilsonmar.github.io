...
2.  Create a password of sufficient complexity. 8 characters is all that Apple allows. Store that password in a secrets Vault. Use code to retrieve it. Alternately, for example:
