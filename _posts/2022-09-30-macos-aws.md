...
1. First terminate an instance in the Instances within EC2:
   
   https://us-west-2.console.aws.amazon.com/ec2/home?region=us-west-2#Instances

1. Check a "mac2.mental" Instance Type.
1. Pull down the "Instance state" menu to select "Terminate instance".
1. "Shutting-down" will continue to appear after you refresh the screen after "Successfully terminated" alert appears at the top.
1. The instance should eventually disappear from the list, leaving "No matching instances found".

   ### Release Dedicated Host

1. Click the "Dedicated Hosts" menu item at the left under EC2.

   https://us-west-2.console.aws.amazon.com/ec2/home?region=us-west-2#Hosts:

1. Check the checkbox to the right of the Host ID you created earlier.
1. Click "Actions" to pull down the menu to select "Release host".
1. Click the orange "Release" to confirm.
<br /><br />
