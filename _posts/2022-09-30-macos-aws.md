...
37. PROTIP: Instead of using what AWS presents above, use a Terminal based on <a href="#AWSMacConnect">my (enhanced) instructions (below) on how to connect to macOS using SSH</a>.
...
1. When <tt>Password:</tt> appears because of the <tt>sudo</tt>, type in your macOS password (not the VNC password).
