...
## M1 vs. mac1 & mac2 within AWS cloud
...
25. Click the blue "Launch" for "Success! Successfully initiated launch of instance".
26. Click "Instances" and scroll down to your Instance ID.
27. Press command+R to refresh until "Status check: Initializing" changes to "passed". ???

    CAUTION: Do not click "Launch instances" in the Instances UI.

28. Return to "Dedicated Hosts".
...
## Deletion Automation and Scheduling
