...
5. Run this script:
   ...
   <a target="_blank" href="https://docs.amazonaws.cn/en_us/cli/latest/userguide/cli-usage-filter.html">PROTIP</a>: In the for loop which retrieves the list of region in the above script, notice that double-ticks are used instead of $() because output to variable are recognized as a single value.
...
1. Check a "mac2.metal" Instance Type.
