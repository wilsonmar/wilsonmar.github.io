...
TL;DR: Here is a map (flowchart) of how this works:

<img alt="macos-aws-1715x926.jpg" src="https://res.cloudinary.com/dcajqrroq/image/upload/v1674315484/macos-aws-1715x926_lhurp9.jpg">


<a target="_blank" href="https://aws.amazon.com/mac">aws.amazon.com/mac</a> redirecting to<br /><a target="_blank" href="https://aws.amazon.com/ec2/instance-types/mac/">https://aws.amazon.com/ec2/instance-types/mac</a> says
you can now operate a full macOS machine without buying hardware (with <a href="#installbrews">your own brews installed</a>), from almost any tablet. Get a mac laptop temporarily to:
...
5. Run this Bash script code from <a target="_blank" href="https://github.com/wilsonmar/mac-setup/blob/master/aws-info.sh">my repo</a>:
...
11. <a target="_blank" href="https://medium.com/aws-architech/the-instance-family-mac1-is-not-supported-b6ca31154f22">IMPORTANT</a>: Uncheck "Support multiple instance types" to avoid getting</a> the cryptic error message:
...
17. Click "CLI commands" to add Advanced Details: commands issued within instance's terminal after boot-up:
...
20. In the list of Dedicated Hosts that appears, click the checkbox associated with the Host ID you want.
    ...
    CAUTION: You are now being charged, even though you do not use the instance.

    
    ### Terminate EC2 Instance

21. <a target="_blank" href="https://www.youtube.com/watch?v=dapXcfhMoGw">VIDEO</a>: Use a browser to the EC2 Instances page for your region.
    
    https://us-west-2.console.aws.amazon.com/ec2/home?region=us-west-2#Instances

22. Check a "mac2.metal" Instance Type.
23. Pull down the "Instance state" menu to select "Terminate instance".
24. "Shutting-down" will continue to appear after you refresh the screen after "Successfully terminated" alert appears at the top.
25. The instance should eventually disappear from the list, leaving "No matching instances found".
...
26. Click the "Dedicated Hosts" menu item at the left under EC2.

    https://us-west-2.console.aws.amazon.com/ec2/home?region=us-west-2#Hosts:

27. Check the checkbox to the right of the Host ID you created earlier.
28. Click "Actions" to pull down the menu to select "Release host".
29. Click the orange "Release" to confirm.
<br /><br />
...
There are two ways to get a mac*.metal instance:
   ...
   <br /><br />
   >>> <a name="OptionB">Option B: Use CLI commands</a> (programmatic commands that require testing adequacy of conditions and verification of results)
   <br /><br />
   >>> <a name="OptionC">Option C: Use Terraform</a> (declarative JSON that's repeatable)
   </ul>
...
6. If you selected a larger volume (above), <a target="_blank" href="https://www.youtube.com/watch?v=--BfdlnIc7Y">VIDEO</a>:
...
7. To enable the VNC <strong>server</strong>, enter the macOS "System Preferences" by clicking the Apple icon in the upper left corner. 
8. Click the blue "Sharing" icon or type enough of "Sharing" in the Search box at the upper-right to choose it.
...
9.  Click "Computer Settings..."
10. Check "VNC viewers may control screen with password:"

11. Create a password of sufficient complexity. 8 characters is all that Apple allows.
12. Store that password in a secrets vault so you can't forget it.
13. Type that password in the form. Press OK.
    ...
    Instead of using a single VNC password, to share access for all current users, replace the last two lines above with:
...
1.  On the client computer that controls the VNC server computer remotely, install the <a target="_blank" href="https://www.realvnc.com/">Real VNC</a> <strong>viewer</strong>:
...
2.  Resize (which takes a few minutes):
