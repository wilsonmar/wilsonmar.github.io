...
15. Write down the name of the Security Group created because they are <strong>not deleted automatically</strong>. Thus, a process is needed to <a href="#RemoveSGroups">remove Security Groups no longer used</a>.
