...
20. In the "Dedicated Hosts details" page, notice that <strong>Allocation time</strong> is the time stamp for when charges begin accumulating.

    For example, "T05:48:03" is a 24-hour <strong>UTC</strong> (previously Greenwich Mean Time near London) but with never a Summertime/Dayight Savings change.
...
21. Normally, you would <a href="#CreateEC2instance">create an EC2 instance to use the Dedicated Host</a> you just created.
...
24. For "Target host by", select the ID of the Dedicated Host you created (above).

    ### Advanced: User data Boot-up commands

25. Scroll to the bottom among "Advanced details".
26. If you have commands to be executed upon on the instance's Terminal after boot-up:
...
29. Click the orange "View all instances" for the list of instances at URL such as:
...
32. REMEMBER: Connecting to the macOS instance is based on the AWS <strong>Public IPv4 DNS name</strong>, such as:
