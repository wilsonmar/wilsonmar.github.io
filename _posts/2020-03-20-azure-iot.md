...
1. <a target="_blank" href="https://docs.microsoft.com/en-us/learn/browse/?products=azure">https://docs.microsoft.com/en-us/learn/browse/?products=azure</a> is the best menu for tutorials because it provides all of Microsoft's tutorials in one menu.

   The great thing about it is it lists by a <strong>recommended sequence</strong> from Beginner thru Intermediate to Advanced levels.
