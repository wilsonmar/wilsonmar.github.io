...
Module 11: ADT (Azure <a href="#Device_Twin">Digital Twins</a>)
...
1. Install. See https://docs.microsoft.com/en-us/cli/azure/install-azure-cli
...
1. In a Terminal, get sub-commands installed:

   <tt>az dt -h</tt>  # for <a href="#Digital_twin">Digital Twin</a>

   <tt>az hub -h</tt>  # for <a href="#IoT_ _Hub">IoT Hub</a>

   <tt>az central -h</tt>  # for <a href="#IoT_ _Central">IoT Central</a>

   <tt>az dps -h</tt>  # for <a href="#DPS">DPS</a>

   <tt>az edge -h</tt>  # for <a href="#Edge">IoT Edge</a>

   <tt>az device -h</tt>  # for <a href="#IoT_Devices">IoT Devices</a>
