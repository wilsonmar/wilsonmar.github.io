...
excerpt: "How to to protect IT assets by mitigating attacker TTPs defined in Mitre's ATT&CK"
...
* <a target="_blank" href="https://atlas.mitre.org/">https://atlas.mitre.org</a> adds columns for AI & ML (Machine Learning).
   ...
   * <a target="_blank" href="https://atlas.mitre.org/mitigations/">PROTIP: Mitigations</a>
...
<a target="_blank" href="https://www.youtube.com/watch?v=44ZLBbzlMus">VIDEO</a>:
<a target="_blank" href="https://www.linkedin.com/in/marksimos/">Mark Simos</a> and Ken Malcolmson
explain Microsoft's view of the cyber attack chain:

<a target="_blank" href="https://res.cloudinary.com/dcajqrroq/image/upload/v1708709384/attack-ms-2548x848_iahvug.png"><img alt="attack-ms-2548x848.png" src="https://res.cloudinary.com/dcajqrroq/image/upload/v1708709384/attack-ms-2548x848_iahvug.png"></a>

They show Microsoft's how product addresses major TTPs.

<a target="_blank" href="https://res.cloudinary.com/dcajqrroq/image/upload/v1708709355/attack-ms-defender-3836x1820_quk73a.png"><img alt="attack-ms-defender-3836x1820.png" src="https://res.cloudinary.com/dcajqrroq/image/upload/v1708709355/attack-ms-defender-3836x1820_quk73a.png"></a>

It's part of the <a target="_blank" href="https://aka.ms/MCRA">Microsoft Reference Architecture</a>

   * Azure Defender for Endpoint
   * Azure Defender for Identity
   * Azure Entra (AD) Identity Protection
   * <a target="_blank" href="https://azure.microsoft.com/en-us/products/defender-for-cloud">Microsoft's Azure Defender for Cloud</a> 
   * Azure Sentinel or insider threats
   <br /><br />

<a target="_blank" href="https://www.linkedin.com/in/johnbflores/">John Flores</a> (<a target="_blank" href="https://github.com/MicrosoftGuyJFlo">MicrosoftGuyJFlo</a>) wrote the <a target="_blank" href="https://github.com/MicrosoftDocs/entra-docs">Entra</a> and <a target="_blank" href="https://github.com/MicrosoftDocs/security">Security</a> docs at Microsoft.
