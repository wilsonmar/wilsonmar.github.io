...
<pre><strong>aws configservice describe-config-rules \
   | grep ConfigRuleName \
   | cut -d":" -f2 \
   | cut -d"," -f1 \
...
The best one I've seen on this topic is <a target="_blank" href="https://linkedin.com/in/dbclinton">David Clinton</a>'s
<a target="_blank" href="https://app.pluralsight.com/library/courses/using-docker-aws/table-of-contents">
"Using Docker on AWS with the Command Line" on Pluralsight</a>, which goes into ECS, Fargate, and EKS using Kubernetes.
The course is the basis for <a target="_blank" href="https://bootstrap-it.com/docker4aws/">"Teach yourself Data Analytics in 30 days: Learn to use Python and Jupyter Notebooks by exploring fun, real-world data projects" at bootstrap-it.com/docker4aws</a>. For your convenience, I've made code from David's webpage available at <a target="_blank" href="https://github.com/wilsonmar/DevSecOps/tree/main/docker4aws">https://github.com/wilsonmar/DevSecOps/tree/main/docker4aws</a>
