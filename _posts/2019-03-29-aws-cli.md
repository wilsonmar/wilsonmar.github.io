...
An example of a service that requires AWS CLI to turn on and off is AWS Config which costs <a target="_blank" href="https://aws.amazon.com/config/pricing/">$4 a month</a>.
