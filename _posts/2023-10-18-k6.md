...
1. Run from within Visual Studio Code, press command+shift+p to get the Command Palette, then type <tt>k6</tt> to get the menu:
   ...
   <pre><strong>k6 run k6-test-ping.js</strong></pre>
...
1. Run the script at <a target="_blank" href="https://test.k6.io/">https://test.k6.io/</a> which loads utility functions from https://jslib.k6.io/k6-utils/1.0.0/index.js
