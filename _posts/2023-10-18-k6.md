...
export default function () {
   ...
   The <strong>options</strong> object specifies that 10 vus (virtual users) run for 30 seconds.

   The <strong>function</strong> object contains calls for getting the specified URL, then sleep for 1 second.
