...
2. See the difference between the working area and staging:
   ...
   <pre><strong>git diff --staged</strong></pre>

   See the difference between the working area and repository:

   <pre><strong>git diff HEAD</strong></pre>
