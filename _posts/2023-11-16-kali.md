...
Here we install Kali Linux and associated tools and <a href="#Metapackages">Kali's Metapackages</a> to run within clouds:

   * <a href="#AWS-Install">AWS cloud VPC for tunneling into Kali</a>
   * <a href="#Azure-Install">Azure cloud VPC for tunneling into Kali</a>
...
The Kali Linux server can theoretically be installed on your laptop:
...
1. <a target="_blank" href="https://wilsonmar.github.io/packer/#Install-Packer">Install Packer on macOS</a>
