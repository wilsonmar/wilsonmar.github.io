...
file: "kali"
title: "Kali (Linux OS)"
excerpt: "Install in AWS, Azure, GCP clouds (with Burt Suite, Postman, etc.) to do penetration testing for security"
tags: [python, coding]
image:
...
Kali is used by several isolated <a target="_blank" href="https://www.wikiwand.com/en/Cyber_range">Cyber Ranges</a>) setup for training and certification.
   * Omar Santos
   * To find 300+ pentest hacking labs: HackTheBox.com
   * TryHackMe.com
   <br /><br />
