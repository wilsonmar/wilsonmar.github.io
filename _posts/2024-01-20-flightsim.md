...
tags: [cloud]
image:
# flightsim-rig-1900x500.png
  feature: https://res.cloudinary.com/dcajqrroq/image/upload/v1706583662/flightsim-rig-1900x500_dwytsk.png
  credit: RTX (5760 x 1080 split across three panels)
  creditlink: https://www.pcgamesn.com/nvidia/rtx-3080-powered-flight-sim-setup
comments: true
---
<i>{{ page.excerpt }}</i> 
{% include l18n.html %}
...
It runs on Microsoft Windows operating systems, and earlier for MS-DOS and Classic Mac OS.

At 2 million lines of code, it was one of the largest computer programs ever written at the time. 
...
However, some say the game is more fun if you are comfortable with aviation terminology:
   * <a href="#Aviation+Terminology">Aviation Terminology (below)</a>
...
<strong>4K UHD 120Hz TV</strong> or monitor:
   ...
   * For maximum wow: <a target="_blank" href="https://www.amazon.com/Optoma-UHD35STx-Entertainment-Projector-Ultra-Low/dp/B09XVNJNXT/">$1,199</a> Optoma UHD35STx Short Throw True 4K UHD Gaming and Home Entertainment Projector 3,600 Lumens for Lights-On Viewing 240Hz Refresh Rate and Ultra-Low 4ms Response Time. It needs a highly reflective screen:
   ...
   * The XBox X does not support ultra-wide monitors.<br />Windows machines do.
   * The Xbox X only has one HDMIv2 monitor out plug.<br />Many Windows machines support dual monitors via GPU such as the NVIDIA GeForce RTX 3090.
...
Stand desk for controls:
   ...
   * <a target="_blank" href="https://www.amazon.com/Techni-Mobili-RTA-B003-GPH06-Adjustable-Graphite/dp/B00WG9A1MK/">$49.99</a> Techni Mobili Rolling Adjustable Laptop Cart, Graphite
...
https://www.youtube.com/watch?v=SQX_Bzj3oD4&t=2m2s
Budget price: $60
FS2020: 2023 Flight Controller Buying Guide For Both Xbox & PC - Low, Mid & High End Budgets!
...
<strong>Xbox Cloud Gaming</strong> was launched by Microsoft in 2019 after three years of work on the competitor Google Stadia and NVIDIA GeForce Now. 
...
1. Press and hold the connect button on your controller to enter pairing mode
