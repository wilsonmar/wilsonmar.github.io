...
layout: post
date: "2025-10-16"
lastchange: "25-10-16 v008 + hero img :2025-10-10-mcp.md"
...
image:
# mcp-1-1918x655.png
  feature: https://res.cloudinary.com/dcajqrroq/image/upload/v1760678410/mcp-1-1918x659_b5hh8x.png
  credit: Wilson Mar
  creditlink:
comments: true
created: "2025-10-10"
...
The equivalent of the above CLI script is a Python program at

<a target="_blank" href="https://github.com/wilsonmar/azure-quickly/blob/main/mcp-ms-learn.py">https://github.com/wilsonmar/azure-quickly/blob/main/mcp-ms-learn.py</a>

The program outputs file mcp-ms-learn.json and mcp-ms-learn.md containing Markdown format.
