...
layout: post
date: "2025-10-17"
lastchange: "25-10-17 v010 + python pgm :2025-10-10-mcp.md"
...
image:
# mcp-1-1916x651.png
  feature: https://res.cloudinary.com/dcajqrroq/image/upload/v1760681496/mcp-1-1916x651_wtc7hb.png
  credit: Wilson Mar
  creditlink:
comments: true
created: "2025-10-10"
...
This article takes a technical deep dive into a MCP Server Microsoft created from just all the documentation they have created, so that you can ask questions in plain English like you do with ChatGPT.
...
outputs file mcp-ms-learn.json and <a target="_blank" href="https://github.com/wilsonmar/azure-quickly/blob/main/mcp-ms-learn.md">mcp-ms-learn.md</a> containing Markdown format.

PROTIP: Right-click on links in the markdown file to open the link in another browser window rather than switching to that page.

Currently, flags that control what functions the program executes are hard-coded.
Production versions of this program obtains variable values from command parameters and .env files.
