...
1. Alternately, "beta" as of April, 2017 is a paid, commercially supported, quality-assured Go distribution
...
1. Click "Minor revisions".

   Go, like everyone else, uses <a target="_blank" href="https://semver.org/">Semantic Versioning</a>.
   ...
   <strong>Install using third-party software installers so new versions can be easily managed automatically from the command-line.</strong>
...
1. Confirm the go executable works:
   ...
   <pre>go version go1.14.5 darwin/amd64
   </pre>
