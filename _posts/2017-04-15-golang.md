...
Unlike C:
   ...
   * can be used with libraries to create GUI as well as CLI programs 
...
Unlike all:
   ...
   * memory used is zeroed if not explicitly initialized
   ...
   * Staying with Go's robust standard library (stdlib) avoids risks from including third-party JavaScript template libraries.
   * no parentheses surrounding the three components of the <a href="#for">for statement</a> 
...
1. Know what is the latest versions of Go installer open-sourced at:
...
0. Confirm the go executable works:
...
There are several good examples of Go programming code on the internet.
   ...
   * <a target="_blank" href="https://www.youtube.com/watch?v=YS4e4q9oBaU">6.5 hour VIDEO: from freecodecamp.com</a>
   * <a target="_blank" href="https://github.com/mkaz/working-with-go/">https://github.com/mkaz/working-with-go</a>
   <br /><br />

1. Take a look at my collection of example code:
...
0. Define $GOPATH environment variable. Open a text editor to edit (~/.bash_profile on Macs) to (replacing wilsonmar with your 
   GitHub account name):
