...
Cloud vendors make use of the <a target="_blank" href="https://cloudsecurityalliance.org/artifacts/consensus-assessments-initiative-questionnaire-v3-1/">Cloud Security Alliance (CSA) Consensus Assessment Initiative Questionnaire (CAIQ) v3.1</a> based on the <a target="_blank" href="https://cloudsecurityalliance.org/research/cloud-controls-matrix/">CSA Cloud Controls Matrix (CCM)</a> from various cloud vendors:
   ...
   * <a target="_blank" href="https://downloads.esri.com/resources/enterprisegis/AGOL_CSA_CAIQ.pdf">PDF: ESRI's answers</a> references both SOC2, <a target="_blank" href="https://www.iso.org/isoiec-27001-information-security.html">ISO 27001:2013</a>, and FedRamp 880-53.
