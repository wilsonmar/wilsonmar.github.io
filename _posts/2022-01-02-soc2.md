...
There is a full and lite versions of CAIQ. The full 310 questions in v3.1 and 261 questions in v4.0 map validated controls according to 16 control categories, in this (alphabetical) order by code:
...
Additionally, there may be more TSC’s which needed to be evaluated in addition to the standard criteria, depending on which <a href="#TSC">TSC categories</a> are being assessed.
