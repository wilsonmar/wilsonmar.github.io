...
<a target="_blank" href="https://res.cloudinary.com/dcajqrroq/image/upload/v1705938418/soc2-polar-1166x718_mow6f2.png"><img align="right" alt="soc2-polar-1166x718.png" src="https://res.cloudinary.com/dcajqrroq/image/upload/v1705938418/soc2-polar-1166x718_mow6f2.png"></a>
...
The diagram at right shows the 5 TSCs in a polar chart over time, with a different color for each evaluation point.

Some use levels from <a target="_blank" href="https://logrhythm.com/solutions/security-operations-maturity-model/">SOMM (Security Operations Maturity)</a> score:
   * 0 = Incomplete = No controls in place
   * 1 = Initial = Controls <strong>in place</strong>, but not documented
   * 2 = Managed = Controls in place and <strong>documented</strong>
   * 3 = Measured = Controls in place, documented, and <strong>tested</strong>
   * 4 = Defined = Controls in place, documented, tested, and <strong>improved</strong>
