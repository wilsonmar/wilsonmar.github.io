...
2. <a href="#AAC-">AAC</a>  (Audit Assurance & Compliance)
...
5. <a href="#DSI-">DSI</a>  (Data Security & Information Lifecycle Management)
6. <a href="#DCS-">DCS</a>  (Datacenter Security)
7. <a href="#EKM-">EKM</a>  (Encryption & Key Management)
8. <a href="#GRM-">GRM</a>  (Governance and Risk Management)
9. <a href="#HRS-">HRS</a>  (Human Resources)

10. <a href="#IAM-">IAM</a>  (Identity & Access Management)
11. <a href="#IVS-">IVS</a>  (Infrastructure & Virtualization Security)
12. <a href="#IPY-">IPY</a>  (Interoperability & Portability)
13. <a href="#MOS-">MOS</a>  (Mobile Security)
14. <a href="#SEF-">SEF</a>  (Security Incident Management, E-Discovery, & Cloud Forensics)

15. <a href="#STA-">STA</a>  (Supply Chain Management)
16. <a href="#TVM-">TVM</a>  (Threat and Vulnerability Management) 

<hr />

\1. <a name="AIS-"><tt>AIS-</tt></a> (Application & Interface Security)

1. Few

  1. Because Consul issues <strong>Health Checks</strong> of services, Consul is able to only route traffic to healthy app services.
   <br /><br />

\2. <a name="AAC-"><tt>AAC-</tt></a>  (Audit Assurance & Compliance)

\3. <a name="BCR-"><tt>BCR-</tt></a>  (Business Continuing Management & Operational Resilience)

1. We configure Enterprise Consul to use Consul <strong>Redundancy Zones</strong>, which ???
<br /><br />

\4. <a name="CCC-"><tt>CCC-</tt></a>  (Change Control & Configuration Management)

1. We configure Enterprise Consul to perform <strong>upgrades</strong> automatically. On AWS, Consul works with ASG (Auto Scaling Groups).
<br /><br />

\5. <a name="DSI-"><tt>DSI-</tt></a>  (Data Security & Information Lifecycle Management)

\6. <a name="DCS-"><tt>DCS-</tt></a>  (Datacenter Security)

\7. <a name="EKM-"><tt>EKM-</tt></a>  (Encryption & Key Management)
1. We configure Enterprise Consul to use a Consul Network Mesh provide <strong>mTLS (Mutual TLS)</strong> communicatons between app services and also with services (through a Gateway) on a wide variety of services:
<br /><br />


\8. <a name="GRM-"><tt>GRM-</tt></a>  (Governance and Risk Management)

\9. <a name="HRS-"><tt>HRS-</tt></a>  (Human Resources)

\10. <a name="IAM-"><tt>IAM-</tt></a>  (Identity & Access Management)

\11. <a name="IVS-"><tt>IVS-</tt></a>  (Infrastructure & Virtualization Security)

\12. <a name="IPY-"><tt>IPY-</tt></a>  (Interoperability & Portability)
1. Because Consul is configured with sues Health Checs, Consul is able to only route traffic to healthy app services.
<br /><br />

\13. <a name="MOS-"><tt>MOS-</tt></a>  (Mobile Security)

\14. <a name="SEF-"><tt>SEF-</tt></a>  (Security Incident Management, E-Discovery, & Cloud Forensics)

\15. <a name="STA-"><tt>STA-</tt></a>  (Supply Chain Management)
