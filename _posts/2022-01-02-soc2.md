...
NOTE: "SOC2" is implemented partly by a <a target="_blank" href="https://wilsonmar.github.io/soc-siem-soar/">Security Operations Center</a>", but does not mean "Systems on a Chip" (another <a target="_blank" href="https://wilsonmar.github.io/acronyms">acronyms</a>).
...
The effort also decreases sales cycles and win rates. Cloud salespeople report that it is "table stakes" to provide a <strong>SOC2 Type II report</strong> to prospects. 
...
Our organization's status toward achieving the <a href="#TSCs">five TSCs (Trust Services Criteria) for SOC2</a> is summarized in (<a target="_blank" href="https://7451111251303.gumroad.com/l/qagsq">this polar chart</a>, with a line for each moment of time, starting from A to B to C at completion:
...
<a target="_blank" href="https://res.cloudinary.com/dcajqrroq/image/upload/v1705947975/soc2-somm-240122-2884x1152_oehmgp.png"><img alt="soc2-somm-240122-2884x1152.png" src="https://res.cloudinary.com/dcajqrroq/image/upload/v1705947975/soc2-somm-240122-2884x1152_oehmgp.png"></a>
   ...
   * 2 = MANAGED = Controls in place <strong>follow plans and policies</strong>
   * 3 = MEASURED = Controls in place, documented, and <strong>tested</strong>
   * 4 = DEFINED = Controls in place, documented, tested, and <strong>standardized</strong>
   * 5 = OPTIMIZED = Controls in place, documented, tested, and <strong>improved</strong>
   <br /><br />
...
The Five Trust Services Criteria (TSC), listed here in alphabetical order:

* <strong>Availability</strong> - Performance monitoring, Disaster Recovery, Security Incident Handling
* <strong>Confidentiality</strong> - Protected information, Data subjects, Privacy
* <strong>Privacy</strong> - Personal information, Sector privacy rules, Encryption
* <strong>Processing Integrity</strong> - Payment transactions, Accurate process (via Quality Assurance), Errors corrected
* <strong>Security</strong> - (aka required Common Criteria) Firewalls, Security controls, Device configuration
<br /><br />
...
The 2013 version was illustrated by this:
...
TSP Section 100.08 describes four additional internal controls criteria:
   ...
   * <a href="#change-management-cc8">Change Management</a>CC8 = How an entity recognizes the necessity for changes, executes the changes using a controlled process, and stops unauthorized changes from occurring.
...
That's 17 x 5 = 85 items for each organizational level. 
For an organization with 4 levels, that's 17 x 5 x 4 = 340 items.
...
CC1.1 The entity demonstrates a commitment to <strong>integrity and ethical values</strong>.

CC1.2 The board of directors demonstrates <strong>independence from management</strong> and
exercises <strong>oversight</strong> of the development and performance of internal control.

CC1.3 FOCUS: Management establishes, with board oversight, structures, reporting lines, and appropriate authorities and responsibilities in the pursuit of
objectives.

CC1.4 The organization demonstrates a commitment to attract, develop, and retain competent individuals in alignment with objectives.

CC1.5 FOCUS: The organization holds individuals accountable for their internal control responsibilities in the pursuit of objectives.

### Communication and Information (CC2)

CC2.1 FOCUS: The entity obtains or generates and uses relevant, <strong>quality information</strong> to support the functioning of internal control.

CC2.2 FOCUS: The entity internally communicates information, including <strong>objectives and responsibilities</strong> for internal control, necessary to support the functioning of internal control.

CC2.3 FOCUS: The entity communicates with <strong>external parties</strong> regarding matters affecting the functioning of internal control.

### Risk Assessment (CC3)

CC3.1 The entity specifies objectives with sufficient clarity to enable the <strong>identification and assessment</strong> of risks relating to objectives.

CC3.2 FOCUS: The entity identifies risks to the achievement of its objectives across the entity and analyzes risks as a basis for determining how the <strong>risks should be managed</strong>.

CC3.3 The entity considers the <strong>potential for fraud</strong> in assessing risks to the achievement of objectives.

CC3.4 FOCUS: The entity identifies and <strong>assesses changes</strong> that could significantly affect the system of internal control.

### Monitoring Activities (CC4)

CC4.1 The entity selects, develops, and performs ongoing and/or
separate <strong>evaluations</strong> to ascertain whether the components of internal control are present and functioning.

CC4.2 The entity evaluates and communicates internal control <strong>deficiencies</strong> in a timely manner to those parties responsible for taking corrective action, including senior management and the board of directors, as appropriate.

### Control Activities (CC5)

CC5.1 The entity selects and develops control activities that contribute to the <strong>mitigation of risks</strong> to the achievement of objectives to acceptable levels.

CC5.2 The entity selects and develops general <strong>control activities over technology</strong> to support the achievement of objectives.

CC5.3 The entity deploys control activities through <strong>policies</strong> that establish what is expected and <strong>procedures</strong> that put policies into action.
...
The below is generated by a Python program excel-to-gm.py using library xlrd which enables reading of an Excel spreadsheet file CAIQ4.0.1.xlsx (for CAIQ v4.0.1), after manual removal of text wrap and line breaks with <tt>=SUBSTITUTE(A1,CHAR(10)," ")</tt>
A feature flag in the program can output only lines which contain an answer.
...
* Acceptable Use of Technology Policy and Procedures	<a href="#HRS-02.1">HRS-02.1</a>
* Access Control Logs	<a href="#LOG-12.1">LOG-12.1</a>
* Anti-Malware Detection and Prevention	<a href="#UEM-09.1">UEM-09.1</a>
* Application and Interface Security Policy and Procedures	<a href="#AIS-01.1">AIS-01.1</a>
* Application and Service Approval	<a href="#UEM-02.1">UEM-02.1</a>
* Application Interface Availability	<a href="#IPY-02.1">IPY-02.1</a>
* Application Security Baseline Requirements	<a href="#AIS-02.1">AIS-02.1</a>
* Application Security Metrics	<a href="#AIS-03.1">AIS-03.1</a>
* Application Vulnerability Remediation	<a href="#AIS-07.1">AIS-07.1</a>
* Asset returns	<a href="#HRS-05.1">HRS-05.1</a>
* Assets Cataloguing and Tracking	<a href="#DCS-06.1">DCS-06.1</a>
* Assets Classification	<a href="#DCS-05.1">DCS-05.1</a>
* Audit and Assurance Policy and Procedures	<a href="#A&A-01.1">A&A-01.1</a>
* Audit Logs Access and Accountability	<a href="#LOG-04.1">LOG-04.1</a>
* Audit Logs Monitoring and Response	<a href="#LOG-05.1">LOG-05.1</a>
* Audit Logs Protection	<a href="#LOG-02.1">LOG-02.1</a>
* Audit Management Process	<a href="#A&A-05.1">A&A-05.1</a>
* Authorization Mechanisms	<a href="#IAM-16.1">IAM-16.1</a>
* Automated Application Security Testing	<a href="#AIS-05.1">AIS-05.1</a>
* Automated Secure Application Deployment	<a href="#AIS-06.1">AIS-06.1</a>
* Automatic Lock Screen	<a href="#UEM-06.1">UEM-06.1</a>
* Background Screening Policy and Procedures	<a href="#HRS-01.1">HRS-01.1</a>
* Backup	<a href="#BCR-08.1">BCR-08.1</a>
* Business Continuity Exercises	<a href="#BCR-06.1">BCR-06.1</a>
* Business Continuity Management Policy and Procedures	<a href="#BCR-01.1">BCR-01.1</a>
* Business Continuity Planning	<a href="#BCR-04.1">BCR-04.1</a>
* Business Continuity Strategy	<a href="#BCR-03.1">BCR-03.1</a>
* Cabling Security	<a href="#DCS-12.1">DCS-12.1</a>
* Capacity and Resource Planning	<a href="#IVS-02.1">IVS-02.1</a>
* CEK Roles and Responsibilities	<a href="#CEK-02.1">CEK-02.1</a>
* Change Agreements	<a href="#CCC-05.1">CCC-05.1</a>
* Change Management Baseline	<a href="#CCC-06.1">CCC-06.1</a>
* Change Management Policy and Procedures	<a href="#CCC-01.1">CCC-01.1</a>
* Change Management Technology	<a href="#CCC-03.1">CCC-03.1</a>
* Change Restoration	<a href="#CCC-09.1">CCC-09.1</a>
* Clean Desk Policy and Procedures	<a href="#HRS-03.1">HRS-03.1</a>
* Clock Synchronization	<a href="#LOG-06.1">LOG-06.1</a>
* Communication	<a href="#BCR-07.1">BCR-07.1</a>
* Compatibility	<a href="#UEM-03.1">UEM-03.1</a>
* Compliance User Responsibility	<a href="#HRS-13.1">HRS-13.1</a>
* Controlled Access Points	<a href="#DCS-07.1">DCS-07.1</a>
* CSC Key Management Capability	<a href="#CEK-08.1">CEK-08.1</a>
* CSCs Approval for Agreed Privileged Access Roles	<a href="#IAM-11.1">IAM-11.1</a>
* Data Classification	<a href="#DSP-04.1">DSP-04.1</a>
* Data Encryption	<a href="#CEK-03.1">CEK-03.1</a>
* Data Flow Documentation	<a href="#DSP-05.1">DSP-05.1</a>
* Data Inventory	<a href="#DSP-03.1">DSP-03.1</a>
* Data Location	<a href="#DSP-19.1">DSP-19.1</a>
* Data Loss Prevention	<a href="#UEM-11.1">UEM-11.1</a>
* Data Ownership and Stewardship	<a href="#DSP-06.1">DSP-06.1</a>
* Data Portability Contractual Obligations	<a href="#IPY-04.1">IPY-04.1</a>
* Data Privacy by Design and Default	<a href="#DSP-08.1">DSP-08.1</a>
* Data Protection by Design and Default	<a href="#DSP-07.1">DSP-07.1</a>
* Data Protection Impact Assessment	<a href="#DSP-09.1">DSP-09.1</a>
* Data Retention and Deletion	<a href="#DSP-16.1">DSP-16.1</a>
* Detection of Baseline Deviation	<a href="#CCC-07.1">CCC-07.1</a>
* Detection Updates	<a href="#TVM-04.1">TVM-04.1</a>
* Disaster Response Plan	<a href="#BCR-09.1">BCR-09.1</a>
* Disclosure Notification	<a href="#DSP-18.1">DSP-18.1</a>
* Disclosure of Data Sub-processors	<a href="#DSP-14.1">DSP-14.1</a>
* Documentation	<a href="#BCR-05.1">BCR-05.1</a>
* Employment Agreement Content	<a href="#HRS-08.1">HRS-08.1</a>
* Employment Agreement Process	<a href="#HRS-07.1">HRS-07.1</a>
* Employment Termination	<a href="#HRS-06.1">HRS-06.1</a>
* Encryption Algorithm	<a href="#CEK-04.1">CEK-04.1</a>
* Encryption and Key Management Audit	<a href="#CEK-09.1">CEK-09.1</a>
* Encryption and Key Management Policy and Procedures	<a href="#CEK-01.1">CEK-01.1</a>
* Encryption Change Cost Benefit Analysis	<a href="#CEK-06.1">CEK-06.1</a>
* Encryption Change Management	<a href="#CEK-05.1">CEK-05.1</a>
* Encryption Monitoring and Reporting	<a href="#LOG-10.1">LOG-10.1</a>
* Encryption Risk Management	<a href="#CEK-07.1">CEK-07.1</a>
* Endpoint Devices Policy and Procedures	<a href="#UEM-01.1">UEM-01.1</a>
* Endpoint Inventory	<a href="#UEM-04.1">UEM-04.1</a>
* Endpoint Management	<a href="#UEM-05.1">UEM-05.1</a>
* Environmental Systems	<a href="#DCS-13.1">DCS-13.1</a>
* Equipment Identification	<a href="#DCS-08.1">DCS-08.1</a>
* Equipment Location	<a href="#DCS-15.1">DCS-15.1</a>
* Equipment Redundancy	<a href="#BCR-11.1">BCR-11.1</a>
* Event Triage Processes	<a href="#SEF-06.1">SEF-06.1</a>
* Exception Management	<a href="#CCC-08.1">CCC-08.1</a>
* External Library Vulnerabilities	<a href="#TVM-05.1">TVM-05.1</a>
* Failures and Anomalies Reporting	<a href="#LOG-13.1">LOG-13.1</a>
* Governance Program Policy and Procedures	<a href="#GRC-01.1">GRC-01.1</a>
* Governance Responsibility Model	<a href="#GRC-06.1">GRC-06.1</a>
* Identity and Access Management Policy and Procedures	<a href="#IAM-01.1">IAM-01.1</a>
* Identity Inventory	<a href="#IAM-03.1">IAM-03.1</a>
* Incident Response Metrics	<a href="#SEF-05.1">SEF-05.1</a>
* Incident Response Plans	<a href="#SEF-03.1">SEF-03.1</a>
* Incident Response Testing	<a href="#SEF-04.1">SEF-04.1</a>
* Independent Assessments	<a href="#A&A-02.1">A&A-02.1</a>
* Information Security Program	<a href="#GRC-05.1">GRC-05.1</a>
* Information System Regulatory Mapping	<a href="#GRC-07.1">GRC-07.1</a>
* Infrastructure and Virtualization Security Policy and Procedures	<a href="#IVS-01.1">IVS-01.1</a>
* Internal Compliance Testing	<a href="#STA-11.1">STA-11.1</a>
* Interoperability and Portability Policy and Procedures	<a href="#IPY-01.1">IPY-01.1</a>
* Key Activation	<a href="#CEK-15.1">CEK-15.1</a>
* Key Archival	<a href="#CEK-18.1">CEK-18.1</a>
* Key Compromise	<a href="#CEK-19.1">CEK-19.1</a>
* Key Deactivation	<a href="#CEK-17.1">CEK-17.1</a>
* Key Destruction	<a href="#CEK-14.1">CEK-14.1</a>
* Key Generation	<a href="#CEK-10.1">CEK-10.1</a>
* Key Inventory Management	<a href="#CEK-21.1">CEK-21.1</a>
* Key Purpose	<a href="#CEK-11.1">CEK-11.1</a>
* Key Recovery	<a href="#CEK-20.1">CEK-20.1</a>
* Key Revocation	<a href="#CEK-13.1">CEK-13.1</a>
* Key Rotation	<a href="#CEK-12.1">CEK-12.1</a>
* Key Suspension	<a href="#CEK-16.1">CEK-16.1</a>
* Least Privilege	<a href="#IAM-05.1">IAM-05.1</a>
* Limitation of Production Data Use	<a href="#DSP-15.1">DSP-15.1</a>
* Limitation of Purpose in Personal Data Processing	<a href="#DSP-12.1">DSP-12.1</a>
* Log Protection	<a href="#LOG-09.1">LOG-09.1</a>
* Log Records	<a href="#LOG-08.1">LOG-08.1</a>
* Logging and Monitoring Policy and Procedures	<a href="#LOG-01.1">LOG-01.1</a>
* Logging Scope	<a href="#LOG-07.1">LOG-07.1</a>
* Malware Protection Policy and Procedures	<a href="#TVM-02.1">TVM-02.1</a>
* Management of Privileged Access Roles	<a href="#IAM-10.1">IAM-10.1</a>
* Migration to Cloud Environments	<a href="#IVS-07.1">IVS-07.1</a>
* Network Architecture Documentation	<a href="#IVS-08.1">IVS-08.1</a>
* Network Defense	<a href="#IVS-09.1">IVS-09.1</a>
* Network Security	<a href="#IVS-03.1">IVS-03.1</a>
* Non-Disclosure Agreements	<a href="#HRS-10.1">HRS-10.1</a>
* Off-Site Equipment Disposal Policy and Procedures	<a href="#DCS-01.1">DCS-01.1</a>
* Off-Site Transfer Authorization Policy and Procedures	<a href="#DCS-02.1">DCS-02.1</a>
* Operating Systems	<a href="#UEM-07.1">UEM-07.1</a>
* Organizational Policy Reviews	<a href="#GRC-03.1">GRC-03.1</a>
* OS Hardening and Base Controls	<a href="#IVS-04.1">IVS-04.1</a>
* Passwords Management	<a href="#IAM-15.1">IAM-15.1</a>
* Penetration Testing	<a href="#TVM-06.1">TVM-06.1</a>
* Personal and Sensitive Data Awareness and Training	<a href="#HRS-12.1">HRS-12.1</a>
* Personal Data Access, Reversal, Rectification and Deletion	<a href="#DSP-11.1">DSP-11.1</a>
* Personal Data Sub-processing	<a href="#DSP-13.1">DSP-13.1</a>
* Personnel Roles and Responsibilities	<a href="#HRS-09.1">HRS-09.1</a>
* Points of Contact Maintenance	<a href="#SEF-08.1">SEF-08.1</a>
* Policy Exception Process	<a href="#GRC-04.1">GRC-04.1</a>
* Primary Service and Contractual Agreement	<a href="#STA-09.1">STA-09.1</a>
* Production and Non-Production Environments	<a href="#IVS-05.1">IVS-05.1</a>
* Quality Testing	<a href="#CCC-02.1">CCC-02.1</a>
* Remediation	<a href="#A&A-06.1">A&A-06.1</a>
* Remote and Home Working Policy and Procedures	<a href="#HRS-04.1">HRS-04.1</a>
* Remote Locate	<a href="#UEM-12.1">UEM-12.1</a>
* Remote Wipe	<a href="#UEM-13.1">UEM-13.1</a>
* Requirements Compliance	<a href="#A&A-04.1">A&A-04.1</a>
* Response Plan Exercise	<a href="#BCR-10.1">BCR-10.1</a>
* Risk Assessment and Impact Analysis	<a href="#BCR-02.1">BCR-02.1</a>
* Risk Based Planning Assessment	<a href="#A&A-03.1">A&A-03.1</a>
* Risk Management Program	<a href="#GRC-02.1">GRC-02.1</a>
* Safeguard Logs Integrity	<a href="#IAM-12.1">IAM-12.1</a>
* Secure Application Design and Development	<a href="#AIS-04.1">AIS-04.1</a>
* Secure Area Authorization	<a href="#DCS-09.1">DCS-09.1</a>
* Secure Area Policy and Procedures	<a href="#DCS-03.1">DCS-03.1</a>
* Secure Disposal	<a href="#DSP-02.1">DSP-02.1</a>
* Secure Interoperability and Portability Management	<a href="#IPY-03.1">IPY-03.1</a>
* Secure Media Transportation Policy and Procedures	<a href="#DCS-04.1">DCS-04.1</a>
* Secure Utilities	<a href="#DCS-14.1">DCS-14.1</a>
* Security and Privacy Policy and Procedures	<a href="#DSP-01.1">DSP-01.1</a>
* Security Awareness Training	<a href="#HRS-11.1">HRS-11.1</a>
* Security Breach Notification	<a href="#SEF-07.1">SEF-07.1</a>
* Security Incident Management Policy and Procedures	<a href="#SEF-01.1">SEF-01.1</a>
* Security Monitoring and Alerting	<a href="#LOG-03.1">LOG-03.1</a>
* Segmentation and Segregation	<a href="#IVS-06.1">IVS-06.1</a>
* Segregation of Privileged Access Roles	<a href="#IAM-09.1">IAM-09.1</a>
* Sensitive Data Protection	<a href="#DSP-17.1">DSP-17.1</a>
* Sensitive Data Transfer	<a href="#DSP-10.1">DSP-10.1</a>
* Separation of Duties	<a href="#IAM-04.1">IAM-04.1</a>
* Service Management Policy and Procedures	<a href="#SEF-02.1">SEF-02.1</a>
* Software Firewall	<a href="#UEM-10.1">UEM-10.1</a>
* Special Interest Groups	<a href="#GRC-08.1">GRC-08.1</a>
* SSRM Control Implementation	<a href="#STA-06.1">STA-06.1</a>
* SSRM Control Ownership	<a href="#STA-04.1">STA-04.1</a>
* SSRM Documentation Review	<a href="#STA-05.1">STA-05.1</a>
* SSRM Guidance	<a href="#STA-03.1">STA-03.1</a>
* SSRM Policy and Procedures	<a href="#STA-01.1">STA-01.1</a>
* SSRM Supply Chain	<a href="#STA-02.1">STA-02.1</a>
* Storage Encryption	<a href="#UEM-08.1">UEM-08.1</a>
* Strong Authentication	<a href="#IAM-14.1">IAM-14.1</a>
* Strong Password Policy and Procedures	<a href="#IAM-02.1">IAM-02.1</a>
* Supply Chain Agreement Review	<a href="#STA-10.1">STA-10.1</a>
* Supply Chain Data Security Assessment	<a href="#STA-14.1">STA-14.1</a>
* Supply Chain Governance Review	<a href="#STA-13.1">STA-13.1</a>
* Supply Chain Inventory	<a href="#STA-07.1">STA-07.1</a>
* Supply Chain Risk Management	<a href="#STA-08.1">STA-08.1</a>
* Supply Chain Service Agreement Compliance	<a href="#STA-12.1">STA-12.1</a>
* Surveillance System	<a href="#DCS-10.1">DCS-10.1</a>
...
Videos from the OneTrust (<a target="_blank" href="https://www.youtube.com/watch?v=y1KujIcMvUk" title="closing Sep. 2021">formly Tugboat Logic</a>) SOC 2 Bootcamp:
