...
Cloud vendors make use of the <a target="_blank" href="https://cloudsecurityalliance.org/artifacts/consensus-assessments-initiative-questionnaire-v3-1/">Cloud Security Alliance (CSA) Consensus Assessment Initiative Questionnaire (CAIQ) v3.1</a>. They map validated controls (SOC2, ISO 27001) to <a target="_blank" href="https://cloudsecurityalliance.org/research/cloud-controls-matrix/">CSA Cloud Controls Matrix (CCM)</a>:
