...
\1. <a name="AIS-"><tt>AIS-</tt></a> (Application & Interface Security)
   ...
   Because Consul issues <strong>Health Checks</strong> of services, Consul is able to route traffic <strong>only to healthy app services</strong>.
   <br /><br />
...
\10. <a name="IAM-"><tt>IAM-</tt></a>  (Identity & Access Management)
   ...
   Instead of blindly routing to IP addresses, our app use Consul which uses cryptographic certificates (mTLS) to authenticate with services.
   <br /><br />
...
\12. <a name="IPY-"><tt>IPY-</tt></a>  (Interoperability & Portability)
   ...
   Because Consul is configured with sues Health Checs, Consul is able to only route traffic to healthy app services.
   <br /><br />
...
\15. <a name="STA-"><tt>STA-</tt></a>  (Supply Chain Management)
   ...
   We follow the same standards that we ask our vendors to follow
