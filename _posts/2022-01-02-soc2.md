...
The report PDF that customers request from service providers is a <strong>SOC2 Type II report</strong>. The document contains an attestation from a CPA firm hired by each service provider each year to evaluate and attest that there is proof the service provider indeed has measures in place to protect the integrity, confidentiality, and privacy of data on behalf of customers.

Major cloud vendors Reports posted their SOC2 Type II report in the <a target="_blank" href="https://cloudsecurityalliance.org/star/registry/">Cloud Security Alliance Registry</a> and on their website to signed-on users at:
   * https://console.aws.amazon.com/artifact/reports
   * https://servicetrust.microsoft.com/ 
   * https://cloud.google.com/security/compliance/soc-2
   <br /><br />

Cloud vendors make use of the <a target="_blank" href="https://cloudsecurityalliance.org/artifacts/consensus-assessments-initiative-questionnaire-v3-1/">Cloud Security Alliance (CSA) Consensus Assessment Initiative Questionnaire (CAIQ) v3.1</a> based on the <a target="_blank" href="https://cloudsecurityalliance.org/research/cloud-controls-matrix/">CSA Cloud Controls Matrix (CCM)</a> from various cloud vendors:

   * <a target="_blank" href="https://downloads.esri.com/resources/enterprisegis/AGOL_CSA_CAIQ.pdf">PDF: ESRI's answers</a> references both SOC2, ISO 27001:2013, and FedRamp 880-53.
...
There is a full and lite versions of CAIQ. The full 310 questions in v3.1 and 261 questions in v4.0 map validated controls according to their control categories, in this (alphabetical) order by code:

   1. AIS (Application & Interface Security)
   1. AAC (Audit Assurance & Compliance)
   1. BCR (Business Continuing Management & Operational Resilience)
   1. CCC (Change Control & Configuration Management)
   1. DSI (Data Security & Information Lifecycle Management)
   1. DCS (Datacenter Security)
   1. EKM (Encryption & Key Management)
   1. GRM (Governance and Risk Management)
   1. HRS (Human Resources)
   1. IAM (Identity & Access Management)
   1. IVS (Infrastructure & Virtualization Security)
   1. IPY (Interoperability & Portability)
   1. MOS (Mobile Security)
   1. SEF (Security Incident Management, E-Discovery, & Cloud Forensics)
   1. STA (Supply Chain Management)
   1. TVM (Threat and Vulnerability Management)
   <br /><br />
...
PROTIP: Preparing for a SOC2 audit strengthens an organization's overall security posture and thus lower the potential risk of a security breach.
...
Your customers outside the US will ask for an attestation in the ISO 2700x international standard by independent auditors (not necessarily CPAs).
