...
* (CC) <strong>Security</strong> - (aka required Common Criteria) Firewalls, Security controls, Device configuration.
<br /><br />
...
When considering that there are <a name="COSO+Principles">17 COSO Principls</a>, that's 17 x 3 x 4 = 204 items for an organization with 4 levels.
   ...
   * Legal, HR, IAM & <a href="https://wilsonmar.github.io/soc-siem-soar/">SOC</a> teams
...
* Text to mobile phones: Twilio, etc.
* Chat: Slack, Microsoft Teams, etc.
* Video: Zoom, Microsoft Teams, etc.
...
* Ecommerce: Shopify, GoDaddy, etc.
* CRM (Customer Relationship Management): Salesforce, Microsoft Dynamics, etc.
