...
1. Evaluate and <strong>hire a certified external consultant</strong> (with experience in your particular industry).
...
1. <strong>Educate</strong> each department on the need for each control, the audit process, what documents and evidence are needed, and how to prepare (format) them:
   ...
   * Quizzes and tracking of understanding by individual
   * Tracking of activity and achievements by individual
   <br /><br />
...
1. <strong>Survey</strong> the organization, conduct document reviews, employee interviews, and walk-throughs to identify the amount of time and work to develop controls needed
   ...
   * Use a system to track progress on gaps in each control within each  department
   <br /><br />
...
1. <strong>Track and report progress</strong> each week/month on where each team still needs additional work, with projections toward when audit readiness will occur. Metrics for the Security Operations Center incident response:
