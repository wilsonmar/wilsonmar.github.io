...
1. Click on the arrow to run a specific code block.
...
1. Sample code from Noah Gift's "Minimal Python" book:

   <a target="_blank" href="https://github.com/paiml/minimal-python">https://github.com/paiml/minimal-python</a>
