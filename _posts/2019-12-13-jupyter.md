...
1. To run a specific code block, click on the rounded arrow or position cursor and hold down Shift key to press Return.

1. Try Style Transfer of your own photo:
   https://www.tensorflow.org/hub/tutorials/tf2_arbitrary_image_stylization

1. To run All on a Mac, hold down command + fn and press the "F9".

   For a reminder of that, click the "Runtime" menu.

1. Sample code with "Open in Colab" are in Noah Gift's "Minimal Python" book:
...
0. If you haven't already, make a directory to hold Jupyter <strong>session files</strong>. 
