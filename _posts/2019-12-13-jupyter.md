...
layout: post
title: "Jupyter"
excerpt: "\"Notebooks\" display HTML markup as comments between executable Python code (for Machine Learning and Data Science)"
...
In the above example, data is received from the numpy (np) library's random function, rounded down.
   ...
   As a practical example, let's do a "style transfer" <strong>on a photo file you provide</strong>:
...
1. One place many websites go to get a URL of a photo based on an email is <a target="_blank" href="https://en.gravatar.com/">en.gravatar.com</a>. Sign in using your WordPress email and password, or sign up and download your photo.
...
1. When you see a stylized image you like, right-click on the picture and Save Image As....
   
   <img width="1016" alt="jupyter-amadeo-2032x702" src="https://user-images.githubusercontent.com/300046/136675816-94cc2969-c793-477e-97ab-b43371f537e2.png">
...
1. Replace the "grace_hopper" entry with the URL to your picture:
...
* Sample Notebook code with "Open in Colab" are in Noah Gift's "Minimal Python" book:
   <a target="_blank" href="hhttps://github.com/paiml/minimal-python/blob/master/Chapter1_Minimal_Python.ipynb">https://github.com/paiml/minimal-python/blob/master/Chapter1_Minimal_Python.ipynb</a>
