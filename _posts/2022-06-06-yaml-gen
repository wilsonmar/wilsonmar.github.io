...
5. jsonnet is a data templating language similar to Cue.
...
7. Write a program such as pod.js. Eexamples on how to create Kubernetes YAML in Java, Go, Python, C# are at:

   https://github.com/learnk8s/templating-kubernetes

8. Dhall is a programmable configuration language.
