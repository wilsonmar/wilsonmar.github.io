...
This tutorial is about making use of a formal specification for 
...
MongoDB</a>.
   ...
   http://github.com/swagger-api/swagger-core/wiki</a>.
...
* AWS Chalice for Python. See <a target="_blank" href="https://sonamjha.com/2021/07/build-serverless-application-in-python-within-an-hour-using-aws-chalice">this</a>
