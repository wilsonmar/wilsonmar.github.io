...
https://www.styra.com/blog/using-xacml-with-opa-and-rego-the-best-of-both-worlds/

XACML is an OASIS standard for implementing declarative authorization policy. 
The downside of XACML is its XML format makes it difficult to read.

The Rego policy language is much more concise and readable at expressing policy.
So use an ACML client app to communicate XACM PDP.
