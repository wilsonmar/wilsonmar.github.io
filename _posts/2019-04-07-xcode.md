...
PROTIP: XCode cannot be installed in Command Utilities has already been installed.
...
PROTIP: Newer versions also installs a Git client.
...
1. Manually click "Install" and follow-on prompts.
...
0. Click "Allow" to the pop-up "Do you want to download?".
   ...
   Notice the large size of the file:
