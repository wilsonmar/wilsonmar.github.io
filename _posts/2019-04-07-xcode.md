...
1. Get the version of the Swift program used to develop iOS mobile apps:
   ...
   <pre>Apple Swift version 5.3 (swiftlang-1200.0.29.2 clang-1200.0.30.1)
Target: x86_64-apple-darwin19.6.0
   </pre>

   If jamf installed Xcode, you'll also see:
   <pre>[1]+  Done                    sudo rm -rf /Library/Developer/CommandLineTools jamfselfservice://content?entity=policy</pre>
...
1. Remove all files in that folder, which requires a password for elevated permissions to get all the files:
   ...
   or <a href="#InstallIDE">install the full Xcode IDE</a>.
