...
<a name="Video"></a>
<a target="_blank" href="https://s3.us-east-2.amazonaws.com/mar-grastorf/git-flow-v05.mp4">Click here for a video of the diagram to pop-up in another window</a>
...
Click the Pause button. Drag the timing bubble on the video's timeline.
Play it again.
...
1. Click the command below until the entire line (which wraps around) is highlighted:
   ...
   <tt><strong>sh -c "$(curl -fsSL https://raw.githubusercontent.com/wilsonmar/git-utilities/master/git-flow.sh)"</strong></tt>
