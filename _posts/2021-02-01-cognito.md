...
<a target="_blank" href="https://www.linkedin.com/learning/comptia-security-plus-sy0-601-cert-prep-4-identity-and-access-management-design-and-implementation/saml?autoAdvance=true&autoSkip=false&autoplay=true&resume=true">VIDEO</a>

The Security Assertion Markup Language (SAML) protocol enables Single-Sign-On (SSO) from within a web browser across various systems without the user providing credentials. 
It works like getting an armband at a music concert. 
