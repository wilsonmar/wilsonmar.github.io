...
IonQ's analysis of key industry: https://ionq.com/industry-solutions/
...
About the Number of "2Q" (or 2N): With conventional computers (such as Windows), doubling the number of bits doubles its processing power (a factorial increase). However, adding a qubit to a quantum machine produces an <strong>exponential increase</strong> in its number-crunching ability. Thus, a 30-qubit quantum machine would, in theory, be a million times more powerful than a 10-qubit one. <a target="_blank" href="https://www.science.org/content/article/ibm-promises-1000-qubit-quantum-computer-milestone-2023">IBM seeks</a> a 1,000-qubit machine by 2023, up from 65 in 2020. A 1,000-qubit machine would still be 1000 times too small to break current internet encryption schemes. So Google plans to build a million-qubit quantum computer by 2030.
...
BTW The depth of a circuit is a metric that calculates the longest path between the data input and the output. Each gate counts as a unit.
