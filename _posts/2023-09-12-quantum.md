...
This means that quantum computers can solve problems that were impossible for traditional computers to solve, such as:
   ...
   * Crack encryption cryptography (which calculates prime numbers)
...
Qubits have quirky quantum properties that mean a connected group of them can provide way more processing power than the same number of binary bits. One of those properties is known as superposition and another is called entanglement.
...
Quantum computers harness entangled qubits in a kind of quantum daisy chain. The machines’ ability to speed up calculations using specially designed quantum algorithms is why there’s so much buzz about their potential.
