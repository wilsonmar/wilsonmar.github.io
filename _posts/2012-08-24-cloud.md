...
The Well-Architected Framework provides a structured checklist on how to build cloud-native architectures.
...
* <a href="#Sec">Security</a> = The ability to protect information, systems, and assets (applications and data) from threats
...
<a target="_blank" href="https://console.aws.amazon.com/wellarchitected">The AWS WA Tool</a> provides a set of questions (context) and best practices.
