...
excerpt: "Alter how websites look and what they do. But heed warnings here."
tags: [browsers, UI]
image:
...
## Beware of powerful extensions!

Browser extensions work by their ability to inject <strong>JavaScript</strong> code within internet browsers to modify web content users see and interact with -- changing and extending the behavior of the browser itself.

That can include malicious actions such as theft of your login credentials and other secrets.

## Browser

Browsers have separate user profiles for different environments (accounts).
