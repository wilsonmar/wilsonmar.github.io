...
15. [_] Instead of clicking on links in emails, right-click to copy the URL (web address) to see what various investigators say about it on <strong>Virus Total</strong>, <strong>website</strong> tab.
...
16. [_] Install Google's <a target="_blank" href="https://chrome.google.com/webstore/detail/google-safe-browsing/bkdgflcldnnnapblkhphbgpggdiikppg">Google Safe Browsing extension for Chrome</a>. 

    It warns you if a website you're trying to visit is suspected of phishing or malware.

17. [_] Install a VPN (Virtual Private Network) to encrypt your internet traffic. That way, when you're using a public WiFi network (such as at Starbucks, airports, etc.), hackers can't intercept your traffic and steal your secrets.

    PROTIP: NordVPN and <a target="_blank" href="https://www.expressvpn.com/">ExpressVPN</a> is a popular VPN service that's available for Mac, Windows, iOS, and Android.
