...
11.  Be wary of communications with people you don't know, especially if it's coming from a public email such as gmail.com, outlook.com, etc.  
...
15. Gmail has a feature to add a "+" and a word to your email address. For example, if your email address is "johndoe@gmail.com", you can provide "johndoe+341@gmail.com" to a website. That way, you can tell if they sold your email address to spammers. Keep track of your aliases in your password manager.
...
16.  <strong>Provide fake answers</strong>  used as secrets to reset your password. Generate a different answer for each website and save it on your password vault. Scammers have been known to use pet's name, where you were married, etc. to scam your friends and relatives.
...
20. Install the <strong>Authy</strong> app (from Twillio) on your mobile phone to generate one-time codes for MFA (Multi-Factor Authentication). It's also available as a Chrome extension. It works like Google Authenticator. One unique feature is its data can be backed up so you can use it on multiple devices.
...
23. Along with something you <strong>do every day</strong>, such as taking medicines, making coffee, brushing your teeth, etc. add safety activities: ++
   ...
   * Restart your phone and computer to clear out memory and processes that may have been compromised. That way, if your computer is compromised, hackers won't be able to use it for long.
   <br /><br />

24. Make changing passwords on important websites part of your <strong>monthly routine</strong>. That way, if your password is compromised, hackers won't be able to use it for long.

25. To make it easier to get everything back when you lose your laptop, buy an <strong>external USB hard drive to backup</strong> a full copy of your laptop and phone. Frequent backups allow you to "Time Travel" to any time in the past (perhaps before particular files were "corrupted").
    ...
    PROTIP: Write down each step to recreate your phone and laptop. Such a document (what security pros call a "Playbook") can be the basis for automation. After a security incident, you're best rebuilding your entire device from scratch to be sure to remove any malware that may have been installed. ++

26. While scheduling appointments to leave your home, also schedule time before you leave to take a backup. That way, if your computer is stolen, you won't miss any gaps in changes made. ++
...
30. To have URLs checked automatically when you click, install Google's <a target="_blank" href="https://chrome.google.com/webstore/detail/google-safe-browsing/bkdgflcldnnnapblkhphbgpggdiikppg">Google Safe Browsing extension for Chrome</a>. 
...
32. Install a <strong>browser extension</strong> that blocks ads and trackers. That way, you won't be tracked by advertisers, and you won't be exposed to malicious ads. 

    <a target="_blank" href="https://www.ghostery.com/">Ghostery</a> is a popular browser extension that's available for Chrome, Firefox, Safari, Opera, and Edge.
