...
1.  [_] Visit <a target="_blank" href="https://HaveIbeenPwned.com/">HaveIbeenPwned.com</a> to see if your email address appears on the "dark web" from data extracted from a website you gave your email to. Hackers use leaked emails to try to log into your other accounts and to send you phishing emails and bogus texts in your phone.

    PROTIP: With so many breaches, it's inevitable that your email address will appear on the dark web. So do what's on this page to protect yourself.

2.  [_] Visit <a target="_blank" href="https://www.whitepages.com/">WhitePages.com</a> and <a target="_blank" href="https://www.spokeo.com/">Spokeo.com</a> to see if your (and your family members') age, address, and phone number appear. 

    CAUTION: Almost anyone can be uniquely identified with just an age, zip code, and certainly your phone number.
    ...
    [_] So get a subscription for a service to do it for you, automatically:
...
3.  [_] Do not put your phone number. When required, give them Jenny's number "310.867-5304". That way, not only you won't get spam calls and texts, you don't have to worry about your phone number being used to reset your password.

4.  [_] Do not post your email address on profiles on LinkedIn, GitHub, etc. to be "harvested" by hackers.

5.  [_] <strong>Setup a different email only for banking</strong>, credit cards, and other financials. That way, if your regular email is compromised, hackers won't be able to reset your bank account password.

    PROTIP: Make checking that account a part of your daily routine, along with something you do every day, such as making coffee, taking medicines, etc.

6.  [_] Apply for <strong>credit cards and phone plans using a different zip code</strong> than your home address because your zip code is an item of verification, such as when you use your credit card at gas stations.
    ...
    BONUS TIP: In your suitcase and in your backpack, keep a list of phone numbers to call if you lose your wallet.

7.  [_] Provide fake answers to personal questions, and store them in your password vault. That way, hackers won't be able to reset your password by answering those questions.

    ### Install apps for security

8.  [_] Gmail has a feature to add a "+" and a word to your email address. For example, if your email address is "johndoe@gmail.com", you can provide "johndoe+341@gmail.com" to a website. That way, you can tell if they sold your email address to spammers. Keep track of your aliases in your password manager.

    Gmail also has strong spam filtering. 

9.  [_] <strong>Install a password manager app</strong> that stores your passwords and other secrets in an encrypted vault. That way, it can tell you which password was used more than once. That way, if one of your passwords is compromised, hackers won't be able to use it to log into your other accounts.
    ...
    PROTIP: Use your password manager to generate strong passwords for you. That way, you don't have to remember them. And you won't be tempted to use the same password for multiple websites, which is one of the most common ways people get hacked.
...
10. [_] Provide 1Password credentials to your "digital executor" -- someone you trust (such as a lawyer) to take care of your digital assets when you die or are incapacitated. That way, your family won't have to deal with the hassle of figuring out how to get access to your accounts.

11. [_] Install <strong>Authy</strong> on your mobile phone to generate one-time codes for MFA (Multi-Factor Authentication). 

    With MFA, when yours password is compromised, hackers still won't be able to log into your account.

    Authy is available for iOS, Android, and Mac. It's also available as a Chrome extension. It can be used to generate codes for other apps, such as Google Authenticator. Its data can be backed up so you can use it on multiple devices.

12. [_] Enable MFA on all your important accounts, such as email, banking, credit cards, etc. It does take an extra bit of time, like opening doors for people who visit instead of leaving doors open for anyone to walk in. 


    ### Regular Habits for security

13. [_] Make checking important accounts a part of your <strong>daily routine</strong>, along with something you do every day, such as making coffee, taking medicines, etc. That way, if your account is compromised, you'll be able to promptly take action.

14. [_] Make changing passwords on important websites part of your <strong>monthly routine</strong>. That way, if your password is compromised, hackers won't be able to use it for long.

15. [_] To make it easier to get everything back when you lose your laptop, buy an <strong>external USB hard drive to backup</strong> a full image of your laptop and phone. Backups allow you to "Time Travel" to a time in the past when particular files were not "corrupted".

    PROTIP: If you're using a Mac, use <strong>Time Machine</strong> to backup your computer to an external hard drive. If you're using Windows, use "File History" to backup.

    PROTIP: When scheduling appointments when you'll be leaving your house, schedule time before you leave to take a backup. That way, if your computer is stolen, you won't miss any gaps in changes made.

16. [_] <strong>backup frequently</strong>. On a Mac, use <strong>Time Machine</strong> to backup your computer to an external hard drive. If you're using Windows, use "File History" to backup.

    PROTIP: When scheduling appointments when you'll be leaving your house, schedule time before you leave to take a backup. That way, if your computer is stolen, you won't miss any gaps in changes made.

17. [_] Setup your computer to ALSO backup automatically to the cloud. That way, if your computer and external hard drive are stolen, you'll still have a backup.

18. [_] Resist clicking links in emails and SMS texts that take you to a fake website, <strong>go to the website directly</strong>, using a web address you know is correct because you <strong>save a bookmark</strong> to each of the websites you frequent. 

    ### Browser extensions for security

19. [_] Instead of clicking on links in emails, right-click to copy the URL (web address) to see what various investigators say about it on <strong>Virus Total</strong>, <strong>website</strong> tab. Add this among your browser bookmarks:
...
20. [_] To have URLs checked automatically when you click, install Google's <a target="_blank" href="https://chrome.google.com/webstore/detail/google-safe-browsing/bkdgflcldnnnapblkhphbgpggdiikppg">Google Safe Browsing extension for Chrome</a>. 

    It warns you if a website you're trying to visit is suspected of phishing or malware.

21. [_] Install a VPN (Virtual Private Network) app to encrypt your internet traffic. That way, when you're using a public WiFi network (such as at Starbucks, airports, etc.), hackers can't intercept your traffic and steal your secrets.

    Popular VPN service available for Mac, Windows, iOS, and Android include NordVPN and <a target="_blank" href="https://www.expressvpn.com/">ExpressVPN</a>. But beware that some VPN services are scams that capture everything you type and do, so do your research before choosing one.

22. [_] Install a <strong>browser extension</strong> that blocks ads and trackers. That way, you won't be tracked by advertisers, and you won't be exposed to malicious ads. <a target="_blank" href="https://www.ghostery.com/">Ghostery</a> is a popular browser extension that's available for Chrome, Firefox, Safari, Opera, and Edge.
