...
6.  [_] Research companies on known-good websites:
    ...
    * Courthouse of lawsuits against the company
    ...
    Don't trust reviews on the company's own website. 

7.  [_] Set your email to <strong>not display images unless you click</strong>. Spammers use image URLs to tell whether an email address is valid. If you click on an image or link, they know it's valid. Malware can be installed when you click on a link or an image. So avoid clicking on anything.


    ### Setup accounts safely

8.  [_] Do not post your email address on profiles on LinkedIn, GitHub, etc. to be "harvested" by hackers.

9.  [_] Set your email to not display images unless you click. Spammers use image URLs to tell whether an email address is valid. If you click on an image or link, they know it's valid. Malware can be installed when you click on a link or an image. So avoid clicking on anything.
...
13.  [_] Provide fake answers to personal questions, and store them in your password vault. That way, hackers won't be able to reset your password by answering those questions.
...
18. [_] Install <strong>Authy</strong> on your mobile phone to generate one-time codes for MFA (Multi-Factor Authentication). It's also available as a Chrome extension. It works like Google Authenticator. One unique feature is its data can be backed up so you can use it on multiple devices.

    With MFA, when your password is compromised, hackers still won't be able to log into your account.

19. [_] Enable MFA on all your important accounts, such as email, banking, credit cards, etc. It does take an extra bit of time, like opening doors for people who visit instead of leaving doors open for anyone to walk in. 
