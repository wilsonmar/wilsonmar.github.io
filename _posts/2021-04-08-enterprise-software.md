...
## 1. Automation for large numbers of people and objects
   ...
   Enterprise workers get far more value from <strong>batch</strong> export, import, and processing than from overwhelming dashboards requiring expert manual navigation. Many vendors don't get that. 
...
## 5. Global scale
   ...
   When a large business goes down globally, a lot of money is lost.
...
## 7. Central and distributed planning and approvals
   ...
   The social intelligence to handle command-and-control politics well is worth top dollar.
