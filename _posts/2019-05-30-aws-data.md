...
This is one in a series comparing different databases across different clouds.
...
<img alt="dbs-gartner-2022-570x592.png" width="570" height="592" src="https://res.cloudinary.com/dcajqrroq/image/upload/v1692377356/dbs-gartner-2022-570x592_gyy82c.png">

In 2022 Gartner rated Amazon's offerings at the top-right corner among database vendors:
...
Cloud customers can install in AWS third-party databases like they used to do on-prem:
...
<a target="_blank" href="https://aws.amazon.com/rds/aurora/"><img alt="Amazon-Aurora-150x150.png" width="100" src="https://res.cloudinary.com/dcajqrroq/image/upload/v1692380207/aws-icons/Amazon-Aurora-150x150.png"></a>
Amazon Aurora</a> is a traditional MySQL/PostgreSQL relational database designed to store individual transactional (OLTP) rows of data records rather than aggregated (OLAP) data from multiple sources (in data warehouses).
...
When data is imported into a dataset rather than using a direct SQL query, it uses SPICE (Super-fast, Parallel, In-memory Calculation Engine) allocated for use by all users within each region to rapidly perform advanced calculations and serve data. 

In QuickSight Enterprise edition, data stored in SPICE is encrypted at rest.
