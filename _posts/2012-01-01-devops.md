...
1. Security (Habits around Email/Spam, Password managers, 2FA, VPN, privacy)
1. Interpersonal (Calendars, Appointments, Social Networking, shares, GitHub)

1. Hardware selection (components, speeds, monitoring)
1. Shell (Bash, Zsh) to install laptop components (keyboard speed & shortcuts)
...
1. Performance (Spreadsheets, Algorithms, CUDA Parallel Computing)
