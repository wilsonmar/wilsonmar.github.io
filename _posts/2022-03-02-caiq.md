...
51. <a name="CEK-02.1"></a>CEK-02.1 - CEK Roles and Responsibilities
    ...
    <a name="CEK-03-M2"></a>CEK-03-M2 CCM METRIC SLO = 85% percent of cryptographic modules continue to be up to approved standards.
...
82. <a name="DCS-05.1"></a>DCS-05.1 - Assets Classification
    ...
    <a name="DCS-06-M1"></a>DCS-06-M1 CCM METRIC SLO = 95% percent of managed assets are cataloged and tracked to detected assets.
...
155. <a name="IAM-06.1"></a>IAM-06.1 - User Access Provisioning
     ...
     <a name="IAM-07-M1"></a>IAM-07-M1 CCM METRIC SLO = 99% percent of users leaving the organization are deprovisioned from the identity management system in compliance with identity and access management policies.
...
157. <a name="IAM-08.1"></a>IAM-08.1 - User Access Review
     ...
     <a name="IAM-09-M1"></a>IAM-09-M1 CCM METRIC SLO = 99% percent of users with production access have admin access (duties segregated).
...
196. <a name="LOG-04.1"></a>LOG-04.1 - Audit Logs Access and Accountability
     ...
     <a name="LOG-05-M1"></a>LOG-05-M1 CCM METRIC SLO = 95% percent of discovered anomalies resolved within required timelines  (effective log monitoring and response process).
...
203. <a name="LOG-09.1"></a>LOG-09.1 - Log Protection
     ...
     <a name="LOG-10-M1"></a>LOG-10-M1 CCM METRIC SLO = 80% percent of cryptography, encryption, and key management controls have defined metrics.
...
251. <a name="UEM-04.1"></a>UEM-04.1 - Endpoint Inventory
     ...
     <a name="UEM-05-M1"></a>UEM-05-M1 CCM METRIC SLO = 99% percent of unique endpoints with suitable policy enforcement tools have reported compliance state within the sampling period (ability of an organization to control the configuration and behavior of assets which directly create, read, write, or delete organizational data).
...
255. <a name="UEM-08.1"></a>UEM-08.1 - Storage Encryption
     ...
     <a name="UEM-09-M1"></a>UEM-09-M1 CCM METRIC SLO = 99% percent of instances run anti-malware/virus services.
