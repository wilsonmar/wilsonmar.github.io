...
1. <a href="#A&A-01.1"></a>A&A-01.1 - Audit and Assurance Policy and Procedures
...
1. <a href="#A&A-05.1"></a>A&A-05.1 - Audit Management Process
...
1. <a href="#A&A-06.1"></a>A&A-06.1 - Remediation
...
1. <a href="#A&A-06.2"></a>A&A-06.2 - Remediation
...
1. <a href="#AIS-01.1"></a>AIS-01.1 - Application and Interface Security Policy and Procedures
...
1. <a href="#AIS-01.2"></a>AIS-01.2 - Application and Interface Security Policy and Procedures
 
   Are application security policies and procedures reviewed and updated at least annually?

1. <a href="#AIS-02.1"></a>AIS-02.1 - Application Security Baseline Requirements
 
   Are baseline requirements to secure different applications established, documented, and maintained?

1. <a href="#AIS-03.1"></a>AIS-03.1 - Application Security Metrics
...
1. <a href="#AIS-04.1"></a>AIS-04.1 - Secure Application Design and Development
...
1. <a href="#AIS-05.1"></a>AIS-05.1 - Automated Application Security Testing
...
1. <a href="#AIS-05.2"></a>AIS-05.2 - Automated Application Security Testing
 
   Is testing automated when applicable and possible?

1. <a href="#AIS-06.1"></a>AIS-06.1 - Automated Secure Application Deployment
...
1. <a href="#AIS-07.1"></a>AIS-07.1 - Application Vulnerability Remediation
 
   Are application security vulnerabilities remediated following defined processes?

1. <a href="#AIS-07.2"></a>AIS-07.2 - Application Vulnerability Remediation
...
1. <a href="#BCR-01.1"></a>BCR-01.1 - Business Continuity Management Policy and Procedures
...
1. <a href="#BCR-01.2"></a>BCR-01.2 - Business Continuity Management Policy and Procedures
 
   Are the policies and procedures reviewed and updated at least annually?

1. <a href="#BCR-02.1"></a>BCR-02.1 - Risk Assessment and Impact Analysis
...
1. <a href="#BCR-03.1"></a>BCR-03.1 - Business Continuity Strategy
...
1. <a href="#BCR-04.1"></a>BCR-04.1 - Business Continuity Planning
...
1. <a href="#BCR-05.1"></a>BCR-05.1 - Documentation
...
1. <a href="#BCR-07.1"></a>BCR-07.1 - Communication
...
1. <a href="#BCR-09.1"></a>BCR-09.1 - Disaster Response Plan
...
1. <a href="#CCC-01.1"></a>CCC-01.1 - Change Management Policy and Procedures
...
1. <a href="#CCC-01.2"></a>CCC-01.2 - Change Management Policy and Procedures
 
   Are the policies and procedures reviewed and updated at least annually?

1. <a href="#CCC-02.1"></a>CCC-02.1 - Quality Testing
...
1. <a href="#CCC-04.1"></a>CCC-04.1 - Unauthorized Change Protection
 
   Is the unauthorized addition, removal, update, and management of organization assets restricted?

1. <a href="#CCC-05.1"></a>CCC-05.1 - Change Agreements
...
1. <a href="#CEK-01.1"></a>CEK-01.1 - Encryption and Key Management Policy and Procedures
...
1. <a href="#CEK-04.1"></a>CEK-04.1 - Encryption Algorithm
...
1. <a href="#CEK-05.1"></a>CEK-05.1 - Encryption Change Management
...
1. <a href="#CEK-06.1"></a>CEK-06.1 - Encryption Change Cost Benefit Analysis
...
1. <a href="#CEK-07.1"></a>CEK-07.1 - Encryption Risk Management
...
1. <a href="#CEK-08.1"></a>CEK-08.1 - CSC Key Management Capability
 
   Are CSPs providing CSCs with the capacity to manage their own data encryption keys?

1. <a href="#CEK-09.1"></a>CEK-09.1 - Encryption and Key Management Audit
...
1. <a href="#CEK-11.1"></a>CEK-11.1 - Key Purpose
...
1. <a href="#CEK-14.1"></a>CEK-14.1 - Key Destruction
...
1. <a href="#CEK-15.1"></a>CEK-15.1 - Key Activation
...
1. <a href="#CEK-16.1"></a>CEK-16.1 - Key Suspension
...
1. <a href="#CEK-17.1"></a>CEK-17.1 - Key Deactivation
...
1. <a href="#CEK-18.1"></a>CEK-18.1 - Key Archival
...
1. <a href="#CEK-19.1"></a>CEK-19.1 - Key Compromise
...
1. <a href="#CEK-20.1"></a>CEK-20.1 - Key Recovery
...
1. <a href="#DCS-01.1"></a>DCS-01.1 - Off-Site Equipment Disposal Policy and Procedures
...
1. <a href="#DCS-01.2"></a>DCS-01.2 - Off-Site Equipment Disposal Policy and Procedures
...
1. <a href="#DCS-01.3"></a>DCS-01.3 - Off-Site Equipment Disposal Policy and Procedures
...
1. <a href="#DCS-02.1"></a>DCS-02.1 - Off-Site Transfer Authorization Policy and Procedures
...
1. <a href="#DCS-02.2"></a>DCS-02.2 - Off-Site Transfer Authorization Policy and Procedures
 
   Does a relocation or transfer request require written or cryptographically verifiable authorization?

1. <a href="#DCS-02.3"></a>DCS-02.3 - Off-Site Transfer Authorization Policy and Procedures
...
1. <a href="#DCS-03.1"></a>DCS-03.1 - Secure Area Policy and Procedures
...
1. <a href="#DCS-03.2"></a>DCS-03.2 - Secure Area Policy and Procedures
...
1. <a href="#DCS-04.1"></a>DCS-04.1 - Secure Media Transportation Policy and Procedures
...
1. <a href="#DCS-08.1"></a>DCS-08.1 - Equipment Identification
 
   Is equipment identification used as a method for connection authentication?

1. <a href="#DCS-09.1"></a>DCS-09.1 - Secure Area Authorization
...
1. <a href="#DCS-09.2"></a>DCS-09.2 - Secure Area Authorization
 
   Are access control records retained periodically, as deemed appropriate by the organization?

1. <a href="#DCS-10.1"></a>DCS-10.1 - Surveillance System
...
1. <a href="#DCS-11.1"></a>DCS-11.1 - Unauthorized Access Response Training
 
   Are datacenter personnel trained to respond to unauthorized access or egress attempts?

1. <a href="#DCS-12.1"></a>DCS-12.1 - Cabling Security
...
1. <a href="#DCS-13.1"></a>DCS-13.1 - Environmental Systems
...
1. <a href="#DCS-14.1"></a>DCS-14.1 - Secure Utilities
...
1. <a href="#DSP-01.2"></a>DSP-01.2 - Security and Privacy Policy and Procedures
 
   Are data security and privacy policies and procedures reviewed and updated at least annually?

1. <a href="#DSP-02.1"></a>DSP-02.1 - Secure Disposal
...
1. <a href="#DSP-09.1"></a>DSP-09.1 - Data Protection Impact Assessment
...
1. <a href="#DSP-10.1"></a>DSP-10.1 - Sensitive Data Transfer
...
1. <a href="#DSP-11.1"></a>DSP-11.1 - Personal Data Access, Reversal, Rectification and Deletion
...
1. <a href="#DSP-12.1"></a>DSP-12.1 - Limitation of Purpose in Personal Data Processing
...
1. <a href="#DSP-13.1"></a>DSP-13.1 - Personal Data Sub-processing
...
1. <a href="#DSP-14.1"></a>DSP-14.1 - Disclosure of Data Sub-processors
...
1. <a href="#DSP-15.1"></a>DSP-15.1 - Limitation of Production Data Use
...
1. <a href="#DSP-18.1"></a>DSP-18.1 - Disclosure Notification
...
1. <a href="#DSP-18.2"></a>DSP-18.2 - Disclosure Notification
...
1. <a href="#DSP-19.1"></a>DSP-19.1 - Data Location
...
1. <a href="#GRC-01.1"></a>GRC-01.1 - Governance Program Policy and Procedures
...
1. <a href="#GRC-01.2"></a>GRC-01.2 - Governance Program Policy and Procedures
 
   Are the policies and procedures reviewed and updated at least annually?

1. <a href="#GRC-02.1"></a>GRC-02.1 - Risk Management Program
...
1. <a href="#GRC-03.1"></a>GRC-03.1 - Organizational Policy Reviews
...
1. <a href="#GRC-04.1"></a>GRC-04.1 - Policy Exception Process
...
1. <a href="#GRC-05.1"></a>GRC-05.1 - Information Security Program
...
1. <a href="#GRC-07.1"></a>GRC-07.1 - Information System Regulatory Mapping
...
1. <a href="#GRC-08.1"></a>GRC-08.1 - Special Interest Groups
...
1. <a href="#HRS-01.1"></a>HRS-01.1 - Background Screening Policy and Procedures
...
1. <a href="#HRS-01.2"></a>HRS-01.2 - Background Screening Policy and Procedures
...
1. <a href="#HRS-01.3"></a>HRS-01.3 - Background Screening Policy and Procedures
 
   Are background verification policies and procedures reviewed and updated at least annually?

1. <a href="#HRS-02.1"></a>HRS-02.1 - Acceptable Use of Technology Policy and Procedures
...
1. <a href="#HRS-03.1"></a>HRS-03.1 - Clean Desk Policy and Procedures
...
1. <a href="#HRS-04.1"></a>HRS-04.1 - Remote and Home Working Policy and Procedures
...
1. <a href="#HRS-07.1"></a>HRS-07.1 - Employment Agreement Process
...
1. <a href="#HRS-08.1"></a>HRS-08.1 - Employment Agreement Content
...
1. <a href="#HRS-09.1"></a>HRS-09.1 - Personnel Roles and Responsibilities
 
   Are employee roles and responsibilities relating to information assets and security documented and communicated?

1. <a href="#HRS-10.1"></a>HRS-10.1 - Non-Disclosure Agreements
...
1. <a href="#HRS-11.1"></a>HRS-11.1 - Security Awareness Training
...
1. <a href="#HRS-11.2"></a>HRS-11.2 - Security Awareness Training
 
   Are regular security awareness training updates provided?

1. <a href="#HRS-12.1"></a>HRS-12.1 - Personal and Sensitive Data Awareness and Training
...
1. <a href="#HRS-12.2"></a>HRS-12.2 - Personal and Sensitive Data Awareness and Training
...
1. <a href="#HRS-13.1"></a>HRS-13.1 - Compliance User Responsibility
...
1. <a href="#IAM-01.1"></a>IAM-01.1 - Identity and Access Management Policy and Procedures
...
1. <a href="#IAM-01.2"></a>IAM-01.2 - Identity and Access Management Policy and Procedures
 
   Are identity and access management policies and procedures reviewed and updated at least annually?

1. <a href="#IAM-02.1"></a>IAM-02.1 - Strong Password Policy and Procedures
...
1. <a href="#IAM-07.1"></a>IAM-07.1 - User Access Changes and Revocation
...
1. <a href="#IAM-08.1"></a>IAM-08.1 - User Access Review
...
1. <a href="#IAM-09.1"></a>IAM-09.1 - Segregation of Privileged Access Roles
...
1. <a href="#IAM-10.1"></a>IAM-10.1 - Management of Privileged Access Roles
...
1. <a href="#IAM-10.2"></a>IAM-10.2 - Management of Privileged Access Roles
 
   Are procedures implemented to prevent the culmination of segregated privileged access?

1. <a href="#IAM-11.1"></a>IAM-11.1 - CSCs Approval for Agreed Privileged Access Roles
...
1. <a href="#IAM-12.2"></a>IAM-12.2 - Safeguard Logs Integrity
...
1. <a href="#IAM-14.1"></a>IAM-14.1 - Strong Authentication
...
1. <a href="#IPY-01.2"></a>IPY-01.2 - Interoperability and Portability Policy and Procedures
...
1. <a href="#IPY-01.4"></a>IPY-01.4 - Interoperability and Portability Policy and Procedures
...
1. <a href="#IPY-01.5"></a>IPY-01.5 - Interoperability and Portability Policy and Procedures
...
1. <a href="#IPY-03.1"></a>IPY-03.1 - Secure Interoperability and Portability Management
 
   Are cryptographically secure and standardized network protocols implemented for the management, import, and export of data?

1. <a href="#IPY-04.1"></a>IPY-04.1 - Data Portability Contractual Obligations
...
1. <a href="#IVS-01.1"></a>IVS-01.1 - Infrastructure and Virtualization Security Policy and Procedures
...
1. <a href="#IVS-01.2"></a>IVS-01.2 - Infrastructure and Virtualization Security Policy and Procedures
...
1. <a href="#IVS-03.4"></a>IVS-03.4 - Network Security
 
   Are network configurations reviewed at least annually?

1. <a href="#IVS-03.5"></a>IVS-03.5 - Network Security
...
1. <a href="#IVS-05.1"></a>IVS-05.1 - Production and Non-Production Environments
 
   Are production and non-production environments separated?

1. <a href="#IVS-06.1"></a>IVS-06.1 - Segmentation and Segregation
...
1. <a href="#LOG-01.1"></a>LOG-01.1 - Logging and Monitoring Policy and Procedures
...
1. <a href="#LOG-01.2"></a>LOG-01.2 - Logging and Monitoring Policy and Procedures
...
1. <a href="#LOG-12.1"></a>LOG-12.1 - Access Control Logs
 
   Is physical access logged and monitored using an auditable access control system?

1. <a href="#LOG-13.1"></a>LOG-13.1 - Failures and Anomalies Reporting
...
1. <a href="#SEF-04.1"></a>SEF-04.1 - Incident Response Testing
...
1. <a href="#SEF-05.1"></a>SEF-05.1 - Incident Response Metrics
 
   Are information security incident metrics established and monitored?

1. <a href="#SEF-06.1"></a>SEF-06.1 - Event Triage Processes
...
1. <a href="#SEF-07.1"></a>SEF-07.1 - Security Breach Notification
 
   Are processes, procedures, and technical measures for security breach notifications defined and implemented?

1. <a href="#SEF-07.2"></a>SEF-07.2 - Security Breach Notification
...
1. <a href="#SEF-08.1"></a>SEF-08.1 - Points of Contact Maintenance
   ...
   <a name="STA-"></a>
   ### STA = Supply Chain Management, Transparancy, and Accountability<br /><br />
 
1. <a href="#STA-01.1"></a>STA-01.1 - SSRM Policy and Procedures
...
1. <a href="#STA-10.1"></a>STA-10.1 - Supply Chain Agreement Review
 
   Are supply chain agreements between CSPs and CSCs reviewed at least annually?

1. <a href="#STA-11.1"></a>STA-11.1 - Internal Compliance Testing
...
1. <a href="#STA-12.1"></a>STA-12.1 - Supply Chain Service Agreement Compliance
...
1. <a href="#STA-13.1"></a>STA-13.1 - Supply Chain Governance Review
 
   Are supply chain partner IT governance policies and procedures reviewed periodically?

1. <a href="#STA-14.1"></a>STA-14.1 - Supply Chain Data Security Assessment
 
   Is a process to conduct periodic security assessments for all supply chain organizations defined and implemented?

   <a name="TVM-"></a>
   ### TVM = Threat and Vulnerability Management<br /><br />
 
1. <a href="#TVM-01.1"></a>TVM-01.1 - Threat and Vulnerability Management Policy and Procedures
...
1. <a href="#TVM-01.2"></a>TVM-01.2 - Threat and Vulnerability Management Policy and Procedures
 
   Are threat and vulnerability management policies and procedures reviewed and updated at least annually?

1. <a href="#TVM-02.1"></a>TVM-02.1 - Malware Protection Policy and Procedures
...
1. <a href="#TVM-02.2"></a>TVM-02.2 - Malware Protection Policy and Procedures
 
   Are asset management and malware protection policies and procedures reviewed and updated at least annually?

1. <a href="#TVM-03.1"></a>TVM-03.1 - Vulnerability Remediation Schedule
...
1. <a href="#TVM-04.1"></a>TVM-04.1 - Detection Updates
...
1. <a href="#TVM-05.1"></a>TVM-05.1 - External Library Vulnerabilities
...
1. <a href="#TVM-06.1"></a>TVM-06.1 - Penetration Testing
...
1. <a href="#TVM-07.1"></a>TVM-07.1 - Vulnerability Identification
...
1. <a href="#TVM-08.1"></a>TVM-08.1 - Vulnerability Prioritization
 
   Is vulnerability remediation prioritized using a risk-based model from an industry-recognized framework?

1. <a href="#TVM-09.1"></a>TVM-09.1 - Vulnerability Management Reporting
...
1. <a href="#TVM-10.1"></a>TVM-10.1 - Vulnerability Management Metrics
...
1. <a href="#UEM-01.1"></a>UEM-01.1 - Endpoint Devices Policy and Procedures
...
1. <a href="#UEM-01.2"></a>UEM-01.2 - Endpoint Devices Policy and Procedures
 
   Are universal endpoint management policies and procedures reviewed and updated at least annually?

1. <a href="#UEM-02.1"></a>UEM-02.1 - Application and Service Approval
...
1. <a href="#UEM-03.1"></a>UEM-03.1 - Compatibility
...
1. <a href="#UEM-05.1"></a>UEM-05.1 - Endpoint Management
...
1. <a href="#UEM-06.1"></a>UEM-06.1 - Automatic Lock Screen
...
1. <a href="#UEM-14.1"></a>UEM-14.1 - Third-Party Endpoint Security Posture
