...
15. <a name="AIS-05.2"></a>AIS-05.2 - Automated Application Security Testing
    ...
    <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="AIS-06-M1"></a>AIS-06-M1 CCM METRIC SLO = 95% percent of running production code can be directly traced back to automated security and quality tests that verify the compliance of each build.</td></tr></table>
...
27. <a name="BCR-05.3"></a>BCR-05.3 - Documentation
    ...
    <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="BCR-06-M1"></a>BCR-06-M1 CCM METRIC SLO = 80% percent of critical systems that passed Business Continuity Management and Operational Resilience (CCMv4 domain BCR) tests.</td></tr></table>
...
40. <a name="CCC-02.1"></a>CCC-02.1 - Quality Testing
    ...
    <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="CCC-03-M1"></a>CCC-03-M1 CCM METRIC SLO = 80% percent of all assets have change management technology integrated.</td></tr></table>
...
44. <a name="CCC-06.1"></a>CCC-06.1 - Change Management Baseline
    ...
    <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="CCC-07-M1"></a>CCC-07-M1 CCM METRIC SLO = 95% percent of positive test results from all configuration tests performed.</td></tr></table>
...
51. <a name="CEK-02.1"></a>CEK-02.1 - CEK Roles and Responsibilities
    ...
    <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="CEK-03-M2"></a>CEK-03-M2 CCM METRIC SLO = 85% percent of cryptographic modules continue to be up to approved standards.</td></tr></table>
...
52. <a name="CEK-03.1"></a>CEK-03.1 - Data Encryption
    ...
    <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="CEK-04-M1"></a>CEK-04-M1 CCM METRIC SLO = 90% percent of assets with cryptographic functions meet the organization's defined cryptographic requirements.</td></tr></table>
...
82. <a name="DCS-05.1"></a>DCS-05.1 - Assets Classification
    ...
    <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="DCS-06-M1"></a>DCS-06-M1 CCM METRIC SLO = 95% percent of managed assets are cataloged and tracked to detected assets.</td></tr></table>
...
98. <a name="DSP-03.1"></a>DSP-03.1 - Data Inventory
    ...
    <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="DSP-04-M3"></a>DSP-04-M3 CCM METRIC SLO = 99% percent (ratio) of assets in the asset catalog classified according to the data classification policies specific to each organization.</td></tr></table>
...
122. <a name="GRC-03.1"></a>GRC-03.1 - Organizational Policy Reviews
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="GRC-04-M1"></a>GRC-04-M1 CCM METRIC SLO = 90% percent active policy exceptions where the time to resolution is within the documented timeline for resolution. (the effectiveness of governance exception handling processes).</td></tr></table>
...
155. <a name="IAM-06.1"></a>IAM-06.1 - User Access Provisioning
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="IAM-07-M1"></a>IAM-07-M1 CCM METRIC SLO = 99% percent of users leaving the organization are deprovisioned from the identity management system in compliance with identity and access management policies.</td></tr></table>
...
157. <a name="IAM-08.1"></a>IAM-08.1 - User Access Review
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="IAM-09-M1"></a>IAM-09-M1 CCM METRIC SLO = 99% percent of users with production access have admin access (duties segregated).</td></tr></table>
...
174. <a name="IPY-02.1"></a>IPY-02.1 - Application Interface Availability
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="IPY-03-M2"></a>IPY-03-M2 CCM METRIC SLO = 99.99% percent of data flows use an approved, standardized cryptographic security function for interoperable transmissions of data.</td></tr></table>
...
184. <a name="IVS-03.5"></a>IVS-03.5 - Network Security
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="IVS-04-M1"></a>IVS-04-M1 CCM METRIC SLO = 99.99% percent of assets in compliance with the providerÕs configuration security policy and hardening baselines derived from accepted industry sources (e.g., NIST, vendor recommendations, Center for Internet Security Benchmarks, etc.).</td></tr></table>
...
193. <a name="LOG-02.1"></a>LOG-02.1 - Audit Logs Protection
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="LOG-03-M1"></a>LOG-03-M1 CCM METRIC SLO = 95% percent of logs configured to generate security alerts for anomalous activity across control domains.</td></tr></table>
...
196. <a name="LOG-04.1"></a>LOG-04.1 - Audit Logs Access and Accountability
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="LOG-05-M1"></a>LOG-05-M1 CCM METRIC SLO = 95% percent of discovered anomalies resolved within required timelines  (effective log monitoring and response process).</td></tr></table>
...
203. <a name="LOG-09.1"></a>LOG-09.1 - Log Protection
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="LOG-10-M1"></a>LOG-10-M1 CCM METRIC SLO = 80% percent of cryptography, encryption, and key management controls have defined metrics.</td></tr></table>
...
206. <a name="LOG-12.1"></a>LOG-12.1 - Access Control Logs
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="LOG-13-M2"></a>LOG-13-M2 CCM METRIC SLO = 99% percent  uptime minutes of the monitoring system during the sampling period.</td></tr></table>
...
214. <a name="SEF-04.1"></a>SEF-04.1 - Incident Response Testing
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="SEF-05-M1"></a>SEF-05-M1 CCM METRIC SLO = 90% percent of security events sourced from automated systems.</td></tr></table>
...
226. <a name="STA-06.1"></a>STA-06.1 - SSRM Control Implementation
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="STA-07-M5"></a>STA-07-M5 CCM METRIC SLO = 99% percent of approved supply chain upstream cloud services relationships recorded in logged data connections.</td></tr></table>
...
238. <a name="TVM-02.2"></a>TVM-02.2 - Malware Protection Policy and Procedures
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="TVM-03-M1"></a>TVM-03-M1 CCM METRIC SLO = 99% percent of high and critical vulnerabilities remediated within the organizationÕs policy timeframes. This reflects the time between when a vulnerability is identified on an organizationÕs assets and when remediation is complete.</td></tr></table>
...
242. <a name="TVM-06.1"></a>TVM-06.1 - Penetration Testing
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="TVM-07-M1"></a>TVM-07-M1 CCM METRIC SLO = 99% percent of managed assets scanned monthly.</td></tr></table>
...
245. <a name="TVM-09.1"></a>TVM-09.1 - Vulnerability Management Reporting
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="TVM-10-M1"></a>TVM-10-M1 CCM METRIC SLO = 99%? percent of publicly known vulnerabilities are identified for an organizationÕs assets within the organizationÕs required timeframes.</td></tr></table>
...
250. <a name="UEM-03.1"></a>UEM-03.1 - Compatibility
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="UEM-04-M1"></a>UEM-04-M1 CCM METRIC SLO = 95% percent of endpoints actively maintained in the asset inventory (appearing in security audit logs).</td></tr></table>
...
251. <a name="UEM-04.1"></a>UEM-04.1 - Endpoint Inventory
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="UEM-05-M1"></a>UEM-05-M1 CCM METRIC SLO = 99% percent of unique endpoints with suitable policy enforcement tools have reported compliance state within the sampling period (ability of an organization to control the configuration and behavior of assets which directly create, read, write, or delete organizational data).</td></tr></table>
...
255. <a name="UEM-08.1"></a>UEM-08.1 - Storage Encryption
     ...
     <table border="1" cellpadding="4" cellspacing="0"><tr valign="top"><td><a name="UEM-09-M1"></a>UEM-09-M1 CCM METRIC SLO = 99% percent of instances run anti-malware/virus services.</td></tr></table>
