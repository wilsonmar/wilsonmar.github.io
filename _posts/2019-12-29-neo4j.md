...
1. Look at the Dockerfile   This make use of the Docker image at <a target="_blank" href="https://hub.docker.com/_/neo4j">https://hub.docker.com/_/neo4j</a>
...
1. Install pre-requisite AdoptOpenJDK 8 with Homebrew Cask:
   ...
   <pre><strong>brew cask install adoptopenjdk8
   </strong></pre>
