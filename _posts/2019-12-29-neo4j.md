...
1. Pinch 4 fingers together on the Mac's Touchpad to swipe until you see the Neo4j logo.

   Alternately, in the Mac's Finder app, navigate to your <tt>/Applications</tt> folder. Scroll to see "Neo4j Desktop".
...
1. Click on the logo. You should see this:
   ...
   Now <a href="#AfterDesktopInstall">work with databases</a>.
