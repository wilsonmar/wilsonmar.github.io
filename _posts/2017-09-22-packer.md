...
You my think this tutorial is rather dated because many are migrating from Vagrant images to Docker and Kubernetes.
...
1. Make sure you have enough free disk space (5-10 GB at least).
...
1. If it's there, right-click on an existing VMWare Fusion and Move to Trash.
...
1. Files that appear should be backed up to a USB drive.

0. In Finder Downloads folder, double-click on the .dmg file to run the installer.
0. Double-click "VMWare Fusion.app" in the pop-up.
0. Click "Open" in the pop-up.
0. Type in your password.
0. Click "Agree.
0. Click to agree to Security Extensions.
0. Exit the pop-up by clicking the "X" at the upper-left.
0. On the Fusion installer screen, click Agree.
0. You will be asked to pay $395 for the license after 10 days.
0. PROTIP: Save the License key in 1Password or other repository.
0. Click "OK" to access "System Events.app".
0. Cursor to the top of the screen to click "VMware Fusion" and "About" to verify the version installed.
0. Press command+Q to quit out the program.
0. Open "VMwar Fusion". If you see "Find not found", 

0. In Finder, on the left pane, scroll to the "Locations" section to click the exit icon to the right of "VMware Fusion".
0. To save space, in the Downloads folder, right-click the VMware-Fusion-...dmg and "Move to Trash".

   PROTIP: There is no need to invoke the program from Applications folder (/Applications/VMware Fusion.app). See <a target="_blank" href="https://unix.stackexchange.com/questions/169623/yosemite-fusion-7-0-1-now-gets-could-not-open-dev-vmmon-no-such-file-or-dir">this</a>.

0. Drag the app icon and drop it in the mac's Dock.
