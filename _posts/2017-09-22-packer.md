...
0. Cursor to the top of the screen 

0. In Finder, on the left pane, scroll to the "Drives" section to click the exit icon to the right of "VMware Fusion".
0. To save space, right-click the .dmg and "Move to Trash".
