...
A. The most popular way is to install Packer on your laptop using Homebrew: <a target="_blank" href="https://www.youtube.com/watch?v=u36J2q9rbS0">VIDEO</a>:

   <ul> 
   <pre><strong>brew install packer</strong></pre>

   This approach lets you latere use brew to update Packer to the latest version and even uninstall it:
...
1. Either way, verify the install:
