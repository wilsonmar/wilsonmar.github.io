...
### Prettier node module code
    ...
    To ensure consistency in formating within code files (without spending time caholing people), automatically format the code using <a target="_blank" href="https://prettier.io/">prettier.io</a> (<a target="_blank" href="https://github.com/prettier/prettier/">github.com/prettier/prettier</a>). 
...
1. Invoke pretty-quick manually in code editors (VSCode, etc.).
...
1. Edit <tt>package.json</tt> to add the hook to husky:
  ...
  "husky": {
   ...
   The utility automatically edits Git's pre-commit file within <tt>.git/hooks/pre-commit</tt>.
