...
10. Copy these lines and paste in the Terminal to make a change, then add and commit it for the Git Hook to take action:
   ...
   To ensure consistency in the format in code files (without spending time caholing people), automatically format the code using 
   <a target="_blank" href="https://prettier.io/">prettier.io</a> (<a target="_blank" href="https://github.com/prettier/prettier/">github.com/prettier/prettier</a>). 
   
1. Create or navigate to a folder containing JavaScript NodeJs code. That folder should have been initialized as a Git repository (has a .git folder at root).
...
1. Invoke it manually in code editors 
