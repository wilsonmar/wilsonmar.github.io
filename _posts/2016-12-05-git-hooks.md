...
<a target="_blank" href="https://gitlab.com/pycqa/flake8">flake8</a> is a python wrapper that glues together plugins to check the style and quality of Python code.

1. Installation: http://flake8.pycqa.org/en/latest/index.html#quickstart
...
1. Variables are used to select and ignore <a target="_blank" href="http://flake8.pycqa.org/en/latest/user/error-codes.html">specific warnings or errors</a>:
   ...
   * E251 unexpected spaces around keyword / parameter equals
   ...
   Flake8 calls pep8, pyflakes, mccabe, and third-party plugins.
