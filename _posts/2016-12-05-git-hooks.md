...
1. Install the Prettier in your code editor. In VS Code, open the Command Palette (under the View submenu, or using Cmd+Shift+P on Mac and Ctrl+Shift+P on Windows) to type "Extensions: Install Extensions". In place of "Search Extensions in Markeplace", type "Prettier" (by Esben Petersen), then click "Install". Click "Install" in the detail screen.
