...
This article describes the various (default) configuration settings to make your life easier, less annoying, and more secure.

Doing this would make for less distractions when working on team programming.

Many MacOS system settings can be automated using "dotFiles".

CAUTION: Many commands behave differently in one version of macOS vs. other versions.
...
The Bash shell script begins with this:
...
<a target="_blank" href="https://wilsonmar.github.io/zsh">Zsh</a> vs. Bash?
