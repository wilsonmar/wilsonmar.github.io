...
<a target="_blank" href="https://www.youtube.com/watch?v=8fFNVlpM-Tw">this VIDEO shows how to change the Login Screen background on macOS Monterey</a>. 
It shows how to get your account UUID and create a folder with that name after going to $HOME/Caches and creating folder "Desktop Pictures". Inside that folder, add an image named <strong>lockscreen.png</strong>, such as a default wallpaper downloaded from https://512pixels.net/projects/default-mac-wallpapers-in-5k/ which archives every major version of Mac OS X and macOS (up to Monterey Beta), in 5K and 6K (6016x6016) Extreme Dynamic Range (XDR) resolutions.

Notice that there are both Day and Night pictures starting from 10.14 Mojave, which introduced a new system-wide Dark Mode.
