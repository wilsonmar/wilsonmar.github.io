...
PROTIP: These labs make use of commands rather than interactive UI. 
...
Architecting with Google Kubernetes Engine: Foundations</a> by Brian Rice (Curriculum Lead) provides hands-on Qwiklabs.  Lab: Working with Cloud Build Quiz: Containers and Container Images, The Kubernetes Control Plane, Kubernetes Object Management, 
