...
1. On MacOSX use Homebrew:
   ...
   <pre><strong>brew cask install google-cloud-sdk
   </strong></pre>
...
Customizable 3rd party binaries are supported with SSH access on <a target="_blank" href="https://cloud.google.com/appengine/docs/flexible/">GAE Flexible Enviornment</a>
