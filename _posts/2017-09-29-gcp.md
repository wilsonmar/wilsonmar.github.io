...
Concepts are introduced succinctly after you take a small action, followed by succinct commentary, with links to more information.
...
Google Cloud Deployment Manager vs Terraform vs. Pulumi vs. AWS Co-pilot (AWS CloudFormation) vs. Azure Resource Manager: You still 'describe' your desired state, but by having a programming language at your fingers, you can factor out patterns, and package it up for easier consumption.

## Why Google Cloud?

Google has a fast fibre network connecting machines (via underground cables and undersea cables), 
...
(until late 2018 when AWS offers the same). But still, the global scope of a VPC in Google eliminates the cost and latency of VPN between regions (plus a router for each VPN for BGP). This also enables shareable configuration between projects.
...
Google's Qwiklabs</a> includes cloud instance time (around an hour each class). 
At the end you get a certificate of completion with a graphic to display on your resume.
...
* Google Certified Professional - <a target="_blank" href="#CloudArchitect">Cloud Architect</a>
* Google Certified Professional - <a target="_blank" href="#DataEngineer">Data Engineer</a> (for big data)

* Professional Cloud Developer
* Professional Cloud Data Engineer
* Professional Cloud Network Engineer
* Professional Cloud Security Engineer
* <a target="_blank" href="https://cloud.google.com/certification/cloud-devops-engineer">Professional Cloud DevOps Engineer</a>
...
Each 2 hour $200 exam is 2 hours taken in-person at a
...
## Use Terraform for your own sanity
...
### Permissions
   ...
   * Read <a target="_blank" href="
   https://cloud.google.com/files/Google-CommonSecurity-WhitePaper-v1.4.pdf">
   Google's IT Security PDF</a>
   <br /><br />

IAM Policies: The two types of IAM roles on GCP are primitive (custom) and curated/pre-defined.

   * Primitive roles (Viewer, Editor, Owner, Billing Administrator).
   <br /><br />

<a target="_blank" href="https://www.youtube.com/watch?v=X-kZ_eNtxyU">VIDEO</a>:
GCP IAM Policies are defined as <strong>bindings to roles</strong>.
...
Each Subnet IP range (RFC 1918 CIDR block) is defined across several zones within a particular region.
