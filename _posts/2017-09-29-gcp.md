...
2. <a target="_blank" href="https://www.coursera.org/specializations/architecting-google-kubernetes-engine">Architecting with Google Kubernetes Engine</a> is part of the learning path.
