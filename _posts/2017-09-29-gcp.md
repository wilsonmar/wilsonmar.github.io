...
In the "Products & solutions" page at https://console.cloud.google.com/products, notice that items of each category are in order of <strong>popularity</strong>:
   ...
   * <a href="#BIGDATA">Analytics</a> (<a href="#BigQuery">BigQuery</a>, Pub/Sub, Dataflow, Composer, Dataproc, Dataprep, IoT Core, Data Fusion, Looker, Healthcare, Financial Services, Datastream, Life Sciences, Data Catalog, Elastic Cloud, Databricks, Dataplex) 
   ...
   * <a href="#DATABASES">Databases</a> (SQL, Datastore, Filestore, Spanner, Bigtable, Memorystore, Database Migration, MongoDB Atlas, Neo4j Aura, Redis Ent., AlloyDB)
...
## Anthos for multi-cloud on VMware

Anthos provides a single control plane for running Kubernetes Istio and GKE installed in
private on-prem data center hardware.

A Policy Repository stores policies.

Offerings in Cloud Marketplace is also available in Anthos.
...
<strong>Cloud Spanner</strong> is a "globally distributed, ACID-compliant database that automatically handles replicas, sharding, transaction processing, and scaling."
