...
Neo4j open-sourced (at <a target="_blank" href="https://github.com/neo4j/neo4j">github.com/neo4j/neo4j</a>) their "Cypher" OpenCypher query language in 2015. Among their <a target="_blank" href="https://neo4j.com/docs/">docs</a> is a <a target="_blank" href="https://neo4j.com/docs/cypher-refcard/3.5/">"Refcard" of commands</a>.
...
Get in <a target="_blank" href="https://neo4jsandbox.com/">neo4jsandbox.com</a>, which provides built-in guides and sample datasets for popular use cases for a limited time:

   * <a href="#Bloom">Bloom</a> Visual Discovery (a good first one to view)
...
Graph databases build in <strong>"meaning"</strong> within data. 
...
The Gremlin and Resource Description Language (RDL) W3C-defined SPARQL query language RDF4J java framework.
...
Labled property graph:

Objects which have labels, id, and attributes) are called nodes or "Vertices".

A "edge" defines a relationship among vertices.

Connections have key-value properties.

A one-way connection is "Liz and Frank know each other, and Liz is the boss".

A two-way connection is "Ryan and Frank know each other, and are friends".
...
Neo4j has surrounded itself with a rich ecosphere of visualization and analytics tools.
...
Neo4j databases (for multi-cluster routing) communicates using the <a target="_blank" href="https://boltprotocol.org/">Bolt network protocol</a>. Connection credentials are stored in your web browser, such as:
