...
1. Verify access to program:

   <pre><strong>neo4j version</strong></pre>

   The response should be:

   <pre>Usage: neo4j { console | start | stop | restart | status | version }</pre>   
...
includes JavaScript, C# .NET, Python, and Community drivers such as R.
...
It is used by inference engines to discover relationship insights not easily found using traditional approaches. Thus, it is popular among (crime) forensic scientists.
