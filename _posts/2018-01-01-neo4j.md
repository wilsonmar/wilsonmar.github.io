...
Instead of a local instance, if you're working as a team of developers, consider always-on availability, on-demand scalability, and support:
   ...
   * <a target="_blank" href="https://graphstory.com/blog/2018/08/enterprise-neo4j-on-google-cloud-platform">GraphStory can stand up</a> Enterprise Neo4j <a target="_blank" href="https://neo4j.com/docs/operations-manual/current/clustering/introduction/">Causal Clusters</a> on Google Cloud Platform. Also on the <a target="_blank" href="https://neo4j.com/developer/neo4j-google-cloud-launcher/">GCP Marketplace</a>.  <a target="_blank" href="https://www.youtube.com/watch?v=QG1CgwIWLUs" title="Mar 14, 2019 by David Allen">INTRO VIDEO</a>

   * <a target="_blank" href="https://neo4j.com/aura/">Neo4j's Aura cloud offering</a> runs on GCP.


## Which graph database and language?

<a target="_blank" href="https://db-engines.com/en/ranking/graph+dbms">
This ranking some time back by db-engines.com</a> lists Neo4j as the most popular graph database.
...
<a target="_blank" href="https://neo4j.com/graphacademy/neo4j-certification/">Sign up here at neo4j.com/graphacademy/neo4j-certification</a> 
...
2. Select the <a href="#Bloom">Bloom</a> "springy" UI for Visual Discovery (a good first one to view)
   ...
   <a target="_blank" href="https://www.youtube.com/watch?v=fIjQ1__Z2Ww">Neo4j Bloom Data Visualization for everyone</a>

   <a target="_blank" href="https://www.youtube.com/watch?v=5wluUfomasg">Ontologies in Neo4j: Semantics and Knowledge Graphs</a>
   ...
   * Paradise Papers by ICIJ (offshore account info leaked)
...
Additional use cases:
   ...
   * fraud detection, 
   * Artificial Intelligence <a target="_blank" href="https://www.youtube.com/watch?v=2ZzGMzitNgo">VIDEO: "Graph databases: The best kept secret for effective AI"</a>
   * Knowledge graph
...
## Terminology: one-way connection

SQL databases from Oracle, MySQL, etc. need to join physical tables together.

But Graph databases build in <strong>"meaning"</strong> within data. 

But with Neo4j, you code by drawing ASCII art such as:

   <pre>(graphs)-[:ARE]->(everywhere)</pre>

Graph databases are labled property graphs.
...
<a target="_blank" href="https://www.youtube.com/watch?v=QG1CgwIWLUs&time=23m50s" title="Mar 14, 2019 by David Allen">[23:50] into VIDEO</a>:<br />
...
An example of a two-way connection is "Ryan and Frank know each other, and are friends".
...
From any folder:
   ...
   Notice the "Required: java = 1.8 ✔" in the response (at time of writing):
...
docker run \
   ...
   * 7687 for Bolt
   ...
   PROTIP: Iinstead of http/https, Neo4j v3 database communicates using the <strong>Bolt</strong> binary protocol (for multi-cluster routing). Bolt operates over a TCP connection or WebSocket. Built-in TLS is enabled by default. It's defined at <a target="_blank" href="https://boltprotocol.org/">Bolt network protocol</a>. Connection credentials are stored in your web browser, such as:
