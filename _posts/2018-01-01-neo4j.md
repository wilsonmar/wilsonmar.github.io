...
## Graph databases are the newest thing!
...
<img alt="neo4j-link-table-488x264.jpg" src="https://user-images.githubusercontent.com/300046/69884353-05d5f300-12a6-11ea-91ed-1e2dcc0e8b28.jpg">
   ...
   SQL can be difficult to work with due to the need for joins and "de-normalized" physical structures. SQL makes it difficult to answer questions that were not already expected ahead of time. requiring refactoring.
   ...
   Instead of elaborate joins, labeled <strong>relationships</strong> between red objects define movie titles and green object <strong>nodes</strong> defining actor names. Red and green differentiate <strong>entity types</strong>. Titles and actor names are <strong>labels</strong>. of the relationship. "ACTED_IN" and "DIRECTED" are <strong>attributes</strong> of relationships.
...
## Use cases in old Console

<a target="_blank" href="http://console.neo4j.org/">http://console.neo4j.org</a> is still available.
