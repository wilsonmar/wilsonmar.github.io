...
The contribution of this article is a maticulously curated sequenced presentation that includes the best tidbits from various resources about this topic.
...
It relationships from the movie "Matrix". [13:26]
...
SQL databases from Oracle, MySQL, etc. need to join physical tables together (using foreign keys).
...
![neo4j-co-example-1154x345](https://user-images.githubusercontent.com/300046/69874771-cf8a7a80-1289-11ea-9c7f-584f04e9534b.jpg)
...
SQL can be hard due to the need for joins and "de-normalized" physical structures.
