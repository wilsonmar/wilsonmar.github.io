...
Additional use cases from <a target="_blank" href="https://www.youtube.com/watch?v=lb90EBfAj0o">VIDEO: "Neo4j Top Use Cases"</a>, etc:
   ...
   * <a target="_blank" href="https://www.youtube.com/watch?v=78r0MgH0u0w&time=38m45s">Episodes of Dr. Who</a>, mentioned by Ian Robertson, Neo4j Lead Engineer. Mar 25, 2015</a>
...
1. Install the latest version offline desktop:

   <pre><strong>brew cask install neo4j
   </strong></pre>

1. Install the latest version server:
...
See /usr/local/var/log/neo4j/neo4j.log for current status.
   ...
   Add <tt>sudo</tt> before the command if you get an error
