...
# feature: Xcode-1900x500-37236
  feature: https://res.cloudinary.com/dcajqrroq/image/upload/v1686983361/san-francisco-1900x500_vrcndf.png
  credit: SFMTA
  creditlink: https://www.sfmta.com/getting-around/muni/cable-cars
comments: true
---
<i>{{ page.excerpt }}</i>
{% include l18n.html %}
...
First of all, have some respect. Say "San Franciso", not "frisco" if you don't want to sound like a tourist.
...
1.  North of Ghirardelli Square is the <a target="_blank" href="https://goo.gl/maps/zdJfguTamhiMvSoPA">Palette Tea House</a>, which serves Chinese dim sum with bay views.
...
1.  Get off to walk through Chinatown for souvenirs and Chinese dim sum.
    ...
    PROTIP: There isn't much to see around the <a target="_blank" href="https://goo.gl/maps/oq4myqC6e69UqoL79">Chinatown arch</a>.
